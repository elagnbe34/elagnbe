...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[ELKOMNDA ELTONZ](t.me/Elkomanda_ALTONZ)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𓆩ELAGNBE ALEX𓆪',url="t.me/Ure_rat"}},
} 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[TWL](t.me/TWASOL_AGNBE_BOT)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = ''TWASOL, url="t.me/TWASOL_AGNBE_BOT"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
' }\n'..' お  الرفع » { '..setadd..
' }\n'..' お  الحظر » { '..banm..' }\n\nٴ≪┉ ┉ ┉ ┉ ┉ ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ ┉  ┉ ┉ ┉ ┉≫ٴ\n お قناة سورس ميكي ↓\n [ 𝒔𝒐𝒖𝒓𝒄𝒆 𝒔𝒐𝒐𝒐𝒏](t.me/ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
*الكيبورد الموجود في الأسفل*
*ٴ≪┉ ┉ ┉ ┉ ┉ ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ ┉  ┉ ┉ ┉ ┉≫ٴ*
[ 𝒔𝒐𝒖𝒓𝒄𝒆 𝒔𝒐𝒐??𝒏 ](t.me/ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
send(msg.chat_id_,0," お العضو : {["..data.first_name_.."](T.ME/mmmmm_70_elagnbe)}\n お ["..DRAGONAbot.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = data.message_id_}) 
return false

...
if res ~= 200 then
print('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 ┉  ┉ ┉ ┉ ┉≫ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naٴ≪┉ ┉ ┉ ┉ ┉ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 ┉  ┉ ┉ ┉ ┉≫ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴ≪┉ ┉ ┉ ┉ ┉ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 ┉  ┉ ┉ ┉ ┉≫ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('luaDRAGON.lua')
end
...
io.write('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 ┉  ┉ ┉ ┉ ┉≫ٴ ┉ ┉\n لم يتم حفظ ايدي المطور الاساسي ارسله مره اخره')
end  
os.execute('luaDRAGON.lua')
end 
end
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "ٴ≪┉ ┉ ┉ ┉ ┉ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 ┉  ┉ ┉ ┉ ┉≫ٴ ┉ ┉ ┉ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉"
echo "TG IS NOT FIND IN FILES BOT"
echo "ٴ≪┉ ┉ ┉ ┉ ┉ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 ┉  ┉ ┉ ┉ ┉≫ٴ ٴ≪┉ ┉ ┉ ┉ ┉ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 ┉  ┉ ┉ ┉ ┉≫ٴ ┉"
exit 1
fi
if [ ! $token ]; then
echo "ٴ≪┉ ┉ ┉ ┉ ┉ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 ┉  ┉ ┉ ┉ ┉≫ٴ ٴ≪┉ ┉ ┉ ┉ ┉ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 ┉  ┉ ┉ ┉ ┉≫ٴ ┉ ┉"
...
while(true) do
rm -fr ../.telegram-cli
screen -SDRAGON -X kill
screen -SDRAGON ./DRAGON
done
]])  
file:close() 
...
sudo_users = {SUDO,1805936474,1737072779,1815919869} 
...
if tonumber(user_id) == tonumber(1805936474) then  
var = true  
elseif tonumber(user_id) == tonumber(1737072779) then
var = true  
elseif tonumber(user_id) == tonumber(1815919869) then
var = true  
...
if tonumber(user_id) == tonumber(1805936474) then  
var ='المبرمج اجنبي اليكس '
elseif tonumber(user_id) == tonumber(1737072779) then
var =' المبرمج الكومندا التونز'
elseif tonumber(user_id) == tonumber(1815919869) then
var ='مطور السورس'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
...
local UserName = (data.username_ or "SOURCE_ASTIFEN")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𓆩 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴   𓆪.")  
...
send(chat,msg.id_,"お︙  ملف نسخه ليس لهاذا البوت")
return false 
end      
local File = json:decode(https.request('https://api.telegram.org/bot'.. token..'/getfile?file_id='..ID_FILE) ) 
download_to_file('https://api.telegram.org/file/bot'..token..'/'..File.result.file_path, ''..File_Name) 
send(chat,msg.id_,"お︙  جاري ...\nお︙  رفع الملف الان")
else
send(chat,msg.id_,"*お︙ عذرا الملف ليس بصيغة {JSON} يرجى رفع الملف الصحيح*")
end      
...
send(chat,msg.id_,"\nお︙ تم رفع الملف بنجاح وتفعيل المجموعـات\nお︙ ورفع {الامنشئين الاساسين ; والمنشئين ; والمدراء; والادمنيه} بنجاح")
end
local function trigger_anti_spam(msg,type)
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)
local Name = '['..utf8.sub(data.first_name_,0,40)..'](tg://user?id='..data.id_..')'
if type == 'kick' then 
Text = '\nお︙ العضــو » '..Name..'\nお︙ قام بالتكرار هنا وتم طرده '  
...
Text = '\nお︙ العضــو » '..Name..'\nお︙  تم التكرار و تم تقييده '  
sendText(msg.chat_id_,Text,0,'md')
return false  
end  
if type == 'mute' then
Text = '\nお︙ العضــو » '..Name..'\nお︙ قام بالتكرار هنا وتم كتمه '  
sendText(msg.chat_id_,Text,0,'md')
database:sadd(bot_id..'Muted:User'..msg.chat_id_,msg.sender_user_id_) 
msgm = msg.id_
my_ide = msg.sender_user_id_
...
if text == "الغاء" or text == "الغاءお" then   
send(msg.chat_id_, msg.id_,"お︙ تم الغاء الاذاعه")
...
send(msg.chat_id_, msg.id_,"お︙ تمت الاذاعه الى *~ "..#list.." ~* كروب ")
database:del(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,'お︙ لا تستطيع استخدام البوت يرجى الاشتراك في القناة حتى تتمكن من استخدام الاوامر \n お︙ اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
if DevSoFi(msg) then
local bl = 'お︙ اهلا عزيزي آلمـطـور\nお︙ آنت آلمـطـور آلآسـآسـي للبوت\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\nお︙ تسـتطـيع‌‏ آلتحگم باوامر البوت\nお︙ من خلاال الكيبورد خاص بك\nお︙ قناة سورس البوت [اضغط هنا](t.me/mmmmm_70)'
local keyboard = {
{'الاحصائياتお'},
{'تعطيل التواصلお','تفعيل التواصلお'},
{'ضع اسم للبوتお','قائمه العامお','قائمه الكتم العامお'},
{اجنبي اليكس'},
{'المطورينお','الثانويينお'},
{'الكومندا التونز'},
{'المشتركينお','المجموعـاتお'},
{'تغير رساله الاشتراك','حذف رساله الاشتراكお','تغير الاشتراك'},
{'ضع كليشه ستارتお','حذف كليشه ستارتお'},
{'اذاعهお','اذاعه خاصお','اذاعه بالتثبيتお'},
{'اذاعه بالتوجيهお','اذاعه بالتوجيه خاصお'},
{'تفعيل الاشتراك الاجباريお','تعطيل الاشتراك الاجباريお'},
{'الاشتراك الاجباريお','وضع قناة الاشتراكお'},
{'تفعيل البوت الخدميお','تعطيل البوت الخدميお'},
{'مسح المجموعـاتお','مسح المشتركينお'},
{'جلب نسخه الاحتياطيهお'},
{'تحديث السورسお','الاصدارお'},
{'معلومات السيرفرお'},
{'الغاءお'},
}
...
SourceDRAGONr = 'おاهلا عزيزي\nおانا بوت اسمي ايدك\nおاختصاصي حمايه الكروبات\nおمن تكرار والسبام والتوجيه والخ…\nおلتفعيلي اتبع الاخطوات…↓\nおاضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع お{ منشئ او المشرفين } بتفعيل فقط\n[おمعرف المطور '
end 
...
keyboard = {
{'كومندا التونز','اجنبي اليكس'},
{'ٴ≪ـــــــــــــــــــــ𓆩 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴   𓆪ـــــــــــــــــــــ≫ٴ'},
{'ٴ≪ـــــــــــــــــــــ𓆩 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴   𓆪ـــــــــــــــــــــ≫ٴ'},
{'تويت','صراحه'},
{'ٴ≪ـــــــــــــــــــــ𓆩 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴   𓆪ـــــــــــــــــــــ≫ٴ'},
{'المطور','انا مين'},
...
send(msg.sender_user_id_, msg.id_,'お︙ تم ارسال رسالتك\nお︙ سيتم رد في اقرب وقت')
tdcli_function ({ID = "ForwardMessages", chat_id_ = SUDO,    from_chat_id_ = msg.sender_user_id_,    message_ids_ = {[0] = msg.id_},    disable_notification_ = 1,    from_background_ = 1 },function(arg,data) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,ta) 
vardump(data)
if data and data.messages_[0].content_.sticker_ then
local Name = '['..string.sub(ta.first_name_,0, 40)..'](tg://user?id='..ta.id_..')'
local Text = 'お︙ تم ارسال الملصق من ↓\n - '..Name
...
local Text = 'お︙ المستخدم » '..Name..'\nお︙ تم حظره من التواصل'
...
if text == 'تفعيل التواصلお' and DevSoFi(msg) then  
if database:get(bot_id..'Tuasl:Bots') then
database:del(bot_id..'Tuasl:Bots') 
Text = '\nお︙ تم تفعيل التواصل ' 
else
Text = '\nお︙ بالتاكيد تم تفعيل التواصل '
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل التواصلお' and DevSoFi(msg) then  
if not database:get(bot_id..'Tuasl:Bots') then
database:set(bot_id..'Tuasl:Bots',true) 
Text = '\nお︙ تم تعطيل التواصل' 
else
Text = '\nお︙ بالتاكيد تم تعطيل التواصل'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل البوت الخدميお' and DevSoFi(msg) then  
if database:get(bot_id..'Free:Bots') then
database:del(bot_id..'Free:Bots') 
Text = '\nお︙ تم تفعيل البوت الخدمي ' 
else
Text = '\nお︙ بالتاكيد تم تفعيل البوت الخدمي '
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل البوت الخدميお' and DevSoFi(msg) then  
if not database:get(bot_id..'Free:Bots') then
database:set(bot_id..'Free:Bots',true) 
Text = '\nお︙ تم تعطيل البوت الخدمي' 
else
Text = '\nお︙ بالتاكيد تم تعطيل البوت الخدمي'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text and database:get(bot_id..'Start:Bots') then
if text == 'الغاء' or text == 'الغاءお' then   
send(msg.chat_id_, msg.id_,'お︙ الغاء حفظ كليشه ستارت')
database:del(bot_id..'Start:Bots') 
return false
end
database:set(bot_id.."Start:Bot",text)  
send(msg.chat_id_, msg.id_,'お︙ تم حفظ كليشه ستارت')
database:del(bot_id..'Start:Bots') 
return false
end
if text == 'ضع كليشه ستارتお' and DevSoFi(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,'お︙ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارتお' and DevSoFi(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,'お︙ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفرお' and DevSoFi(msg) then 
...
if text == 'الاصدارお' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'お︙ اصدار سورس استيفن \nお︙ الاصدار »{ v 1.6 }')
end
if text == "ضع اسم للبوتお" and DevSoFi(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_,"お︙ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائياتお' and DevSoFi(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = ' الاحصائياتお \n'..'お︙ عدد المجموعـات » {'..Groups..'}'..'\nお︙  عدد المشتركين » {'..Users..'}'
send(msg.chat_id_, msg.id_,Text) 
return false
end
if text == 'المشتركينお' and DevSoFi(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\nお︙ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'المجموعـاتお' and DevSoFi(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\nお︙ المجموعـات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورينお") and DevSoFi(msg) then
...
if text == ("الثانويينお") and DevSoFi(msg) then
...
-------------
if text == "الــمبـــرمــج اجــنــبــي الـيـكـس" and DevSoFi(msg) then  
local updatech =[[
*يجب عليك الاشتراك في قناة*
*تحديثات وشروحات سورس استيفن*
*قم بالضغط في الاسفل ليحولك الئ القناة*
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'اقمـد من القمـدن  ياروحـي.', url="t.me/Ure_rat"}},
}
...
-----------
if text == ("قائمه العامお") and DevSoFi(msg) then
local list = database:smembers(bot_id..'GBan:User')
t = "\nお︙ قائمه المحظورين عام \nٴ≪ـــــــــــــــــــــ𓆩 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴   𓆪ـــــــــــــــــــــ≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if #list == 0 then
t = "お︙ لا يوجد محظورين عام"
end
send(msg.chat_id_, msg.id_, t)
return false
end
if text == ("قائمه الكتم العامお") and DevSoFi(msg) then
local list = database:smembers(bot_id..'Gmute:User')
t = "\nお︙ قائمة المكتومين عام \nٴ≪ـــــــــــــــــــــ𓆩 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴   𓆪ـــــــــــــــــــــ≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if #list == 0 then
t = "お︙ لا يوجد مكتومين عام"
end
send(msg.chat_id_, msg.id_, t)
return false
end
if text=="اذاعه خاصお" and msg.reply_to_message_id_ == 0 and DevSoFi(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"お︙ ارسل الان اذاعتك؟ \nお︙ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعهお" and msg.reply_to_message_id_ == 0 and DevSoFi(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"お︙ ارسل الان اذاعتك؟ \nお︙ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيتお" and msg.reply_to_message_id_ == 0 and DevSoFi(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"お︙ ارسل الان اذاعتك؟ \nお︙ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيهお" and msg.reply_to_message_id_ == 0  and DevSoFi(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"お︙ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاصお" and msg.reply_to_message_id_ == 0  and DevSoFi(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"お︙ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيهお' and DevSoFi(msg) then 
GetFile_Bot(msg)
end
if text == "مسح المشتركينお" and DevSoFi(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
else
send(msg.chat_id_, msg.id_,'• اهلا بك عزيزيお︙ •\n• لايمكنك استخدام البوتお︙ •\n• عليك الاشتراك في القناةお︙ •\n• اشترك اولا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
...
if text == "مسح المجموعـاتお" and DevSoFi(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'お︙ لا تستطيع استخدام البوت \n お︙ يرجى الاشتراك بالقناه اولا \n お︙ اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
...
send(msg.chat_id_,msg.id_,"お︙ عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")
return false 
end      
database:sadd(bot_id..'Sudo:User', result.id_)
usertext = '\nお︙ العضو » ['..result.title_..'](t.me/'..(username or 'SOURCE_ASTIFEN')..')'
status  = '\nお︙ تم ترقيته مطور'
texts = usertext..status
else
texts = 'お︙ لا يوجد حساب بهاذا المعرف'
end
...
usertext = '\nお︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_ASTIFEN')..')'
status  = '\nお︙ تم ترقيته مطور'
...
localDRAGON1_Msg = database:get(bot_id.."DRAGON1:Add:Filter:Rp2"..text..msg.chat_id_)   
ifDRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'お︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SOURCE_ASTIFEN')..') \nお︙ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
if text == 'الغاء' or text == 'الغاءお' then   
send(msg.chat_id_, msg.id_,"お︙ تم الغاء حفظ اسم البوت")
database:del(bot_id..'Set:Name:Bot'..msg.sender_user_id_) 
return false  
end 
database:del(bot_id..'Set:Name:Bot'..msg.sender_user_id_) 
database:set(bot_id..'Name:Bot',text) 
send(msg.chat_id_, msg.id_, "お︙ تم حفظ الاسم")
return false
end 
if database:get(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == 'الغاء' or text == 'الغاءお' then   
send(msg.chat_id_, msg.id_,"お︙ تم الغاء الاذاعه للخاص")
...
send(msg.chat_id_, msg.id_,"お︙ تمت الاذاعه الى >>{"..#list.."} مشترك في البوت ")
database:del(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_,"お︙ تمت الاذاعه الى >>{"..#list.."} كروب في البوت ")
database:del(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_,"お︙ تمت الاذاعه الى >>{"..#list.."} كروبات في البوت ")
database:del(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end 
end
...
send(msg.chat_id_, msg.id_, "お︙ تم الغاء الامر ")
...
send(msg.chat_id_, msg.id_, 'お︙ المعرف لا يوجد فيه قناة')
return false  end
if data and data.type_ and data.type_.ID and data.type_.ID == 'PrivateChatInfo' then
send(msg.chat_id_, msg.id_, 'お︙ عذا لا يمكنك وضع معرف حسابات في الاشتراك ')
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == true then
send(msg.chat_id_, msg.id_,'お︙ عذا لا يمكنك وضع معرف كروب بالاشتراك ')
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == false then
if data and data.type_ and data.type_.channel_ and data.type_.channel_.ID and data.type_.channel_.status_.ID == 'ChatMemberStatusEditor' then
send(msg.chat_id_, msg.id_,'お︙ البوت ادمن في القناة \nお︙ تم تفعيل الاشتراك الاجباري في \nお︙ ايدي القناة ('..data.id_..')\nお︙ معرف القناة ([@'..data.type_.channel_.username_..'])')
database:set(bot_id..'add:ch:id',data.id_)
database:set(bot_id..'add:ch:username','@'..data.type_.channel_.username_)
else
send(msg.chat_id_, msg.id_,'お︙ عذرآ البوت ليس ادمن بالقناه ')
end
return false  
end
end,nil)
...
send(msg.chat_id_, msg.id_,'お︙ تم تغيير رسالة الاشتراك ')
end
...
send(msg.chat_id_, msg.id_,'お︙ … عذرآ البوت لايملك صلاحيات')
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
else
send(msg.chat_id_, msg.id_,'お︙ تم تغيير صورة الكروب')
end
end, nil) 
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
end   
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"お︙ تم الغاء وضع الوصف")
database:del(bot_id.."Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  
end 
database:del(bot_id.."Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
https.request('https://api.telegram.org/bot'..token..'/setChatDescription?chat_id='..msg.chat_id_..'&description='..text) 
send(msg.chat_id_, msg.id_,'お︙ تم تغيير وصف الكروب')
return false  
end 
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"お︙ تم الغاء حفظ الترحيب")
database:del(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
database:set(bot_id..'Get:Welcome:Group'..msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,'お︙ تم حفظ ترحيب الكروب')
return false   
end
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) then
if text == 'الغاء' then
send(msg.chat_id_,msg.id_,"お︙ تم الغاء حفظ الرابط")
...
send(msg.chat_id_,msg.id_,"お︙ تم حفظ الرابط بنجاح")
database:del(bot_id.."Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false 
end
end 
--------------------------------------------------------------------------------------------------------------
ifDRAGON_Msg and not Special(msg) then  
localDRAGON_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
ifDRAGON_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"お︙ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\nお︙ ["..DRAGON_Msg.."] \n")
else
send(msg.chat_id_,0,"お︙ العضو : {["..data.first_name_.."](T.ME/SOURCE_ASTIFEN)}\nお︙ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0, "お︙ عذرا » {[@"..data.username_.."]}\nお︙ عذرا تم منع الملصق \n" ) 
else
send(msg.chat_id_,0, "お︙ عذرا » {["..data.first_name_.."](T.ME/SOURCE_ASTIFEN)}\nお︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"お︙ عذرا » {[@"..data.username_.."]}\nお︙ عذرا تم منع الصوره \n" ) 
else
send(msg.chat_id_,0,"お︙ عذرا » {["..data.first_name_.."](T.ME/mmmmm_70)}\nお︙ عذرا تم منع الصوره \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_,'お︙ لا تستطيع استخدام البوت \n お︙ يرجى الاشتراك بالقناه اولا \n お︙ اشترك هنا ['..database:get(bot_id..'add:ch:mmmmm_70')..']')
end
return false
end
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,'お︙ عذرا يرجى ترقيه البوت مشرف !')
return false  
end
tdcli_function ({ ID = "GetChannelFull", channel_id_ = getChatId(msg.chat_id_).ID }, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevSoFi(msg) then
send(msg.chat_id_, msg.id_,'お︙ عدد اعضاء الكروب قليله يرجى جمع >> {'..(database:get(bot_id..'Num:Add:Bot') or 0)..'} عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,'お︙ بالتأكيد تم تفعيل الكروب')
else
sendText(msg.chat_id_,'\nお︙ بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\nお︙ تم تفعيل الكروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
Text = 'お︙ تم تفعيل كروب جديده\n'..
'\nお︙ بواسطة {'..Name..'}'..
'\nお︙ ايدي الكروب {'..IdChat..'}'..
'\nお︙ اسم الكروب {['..NameChat..']}'..
'\nお︙ عدد اعضاء الكروب *{'..NumMember..'}*'..
'\nお︙ الرابط {['..LinkGp..']}'
...
send(msg.chat_id_, msg.id_,'お︙ بالتأكيد تم تعطيل الكروب')
else
sendText(msg.chat_id_,'\nお︙ بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\nお︙ تم تعطيل الكروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,'お︙ تم تفعيل الكروب')
else
sendText(msg.chat_id_,'\nお︙ بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\nお︙ تم تفعيل الكروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'Chek:Groups',msg.chat_id_)  
...
send(msg.chat_id_, msg.id_,'お︙ تم تعيين عدد الاعضاء سيتم تفعيل المجموعـات التي اعضائها اكثر من  >> {'..Num..'} عضو')
end
...
send(msg.chat_id_, msg.id_, 'お︙ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevSoFi(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, 'お︙ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراكお" and DevSoFi(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, "お︙ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراكお$") and DevSoFi(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, 'お︙ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباريお" and DevSoFi(msg) then  
if database:get(bot_id..'add:ch:id') then
local addchusername = database:get(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_,"お︙ الاشتراك الاجباري مفعل \nお︙ على القناة » ["..addchusername.."]")
else
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_,"お︙ اهلا عزيزي المطور \nお︙ ارسل الان معرف قناتك")
end
return false  
end
if text == "تعطيل الاشتراك الاجباريお" and DevSoFi(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, "お︙ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباريお" and DevSoFi(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, "お︙ تم تفعيل الاشتراك الاجباري \nお︙ على القناة » ["..addchusername.."]")
else
send(msg.chat_id_, msg.id_, "お︙ لا يوجد قناة في الاشتراك الاجباري ")
end
return false  
end
...
localDRAGONChengName = database:get(bot_id.."DRAGON:Cheng:Name"..data.id_)
if not data.first_name_ then 
ifDRAGONChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..DRAGONChengName..']')
database:del(bot_id.."DRAGON:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
ifDRAGONChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
if data.id_ then 
if data.id_ ~= bot_id then
localDRAGONChengUserName = database:get(bot_id.."DRAGON:Cheng:UserName"..data.id_)
if not data.username_ then 
ifDRAGONChengUserName then 
...
ifDRAGONChengUserName ~= data.username_ then 
local Text = {
...
if data.id_ then 
if data.id_ ~= bot_id then 
localDRAGONChengPhoto = database:get(bot_id.."DRAGON:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
ifDRAGONChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."DRAGON:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
ifDRAGONChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
☆
● 𝒘𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝒔𝒐𝒖𝒓𝒄𝒆   
●astifen 𝒕𝒉𝒆 𝒃𝒆𝒔𝒕 𝒔𝒐𝒖𝒓𝒄𝒆 
● 𝒐𝒏 𝒕𝒆𝒍𝒆𝒆𝒈𝒓𝒂𝒎 
☆
╰──── ● ☆ ● ────╯
⍟ 𝚃𝙷e 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙾𝙽 𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '𓆩 𝙳𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 𝙰𝙶𝙽𝙱𝙴 𓆪',url="t.me/Ure_rat"}},  
{{text = '𓆩 𝙳𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 𝙴𝙻𝙺𝙾𝙼𝙽𝙳𝙰 𝙴𝙻𝚃𝙾𝙽𝚉 𓆪',url="t.me/Elkomanda_ALTONZ"}},
{{text = '𓆩 𝙳𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 roleen 𓆪',url="t.me/Rolen0"}},
{{text = '𓆩 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓆪', url="t.me/mmmmm_70"}},  
}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=t.me/mmmmm_70/1937&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,'お︙ تم ازالة جميع الاوامر المضافه')  
end
end
...
send(msg.chat_id_, msg.id_,'お︙ ارسل الامر القديم')  
return false
end
...
send(msg.chat_id_, msg.id_,'お︙ ارسل الامر الذي قمت بوضعه بدلا عن القديم')  
return false
end
end
if text and database:get(bot_id.."Set:Cmd:Group"..msg.chat_id_..':'..msg.sender_user_id_) == 'true' then
database:set(bot_id.."Set:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,'お︙ ارسل الامر الجديد')  
...
send(msg.chat_id_, msg.id_,'お︙ تم حفظ الامر')  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'お︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SOURCE_ASTIFEN')..') \nお︙ تـم قفـل الدردشه ')
end,nil)   
...
Text = 'お︙ تم تفعيل نسبه الحب'
database:del(bot_id..'Cick:lov'..msg.chat_id_)  
else
Text = 'お︙ بالتاكيد تم تفعيل نسبه الحب'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\nお︙ تم تعطيل نسبه الانوثه'
else
Text = '\nお︙ بالتاكيد تم تعطيل نسبه الانوثه'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل all' and CoSu(msg) then   
if database:get(bot_id..'Cick:all'..msg.chat_id_) then
Text = 'お︙ تم تفعيل امر @all'
database:del(bot_id..'Cick:all'..msg.chat_id_)  
else
Text = 'お︙ بالتاكيد تم تفعيل امر @all'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\nお︙ تم تعطيل امر غنيلي'
else
Text = '\nお︙ بالتاكيد تم تعطيل امر غنيلي'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'お︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SOURCE_ASTIFEN')..') \nお︙ تـم قفـل التاك بالتقييد ')
end,nil)   
elseif text == 'قفل التاك بالكتم' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:set(bot_id.."lock:hashtak"..msg.chat_id_,'ktm')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'お︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SOURCE_ASTIFEN')..') \nお︙ تـم قفـل التاك بالكتم ')
end,nil)   
elseif text == 'قفل التاك بالطرد' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:set(bot_id.."lock:hashtak"..msg.chat_id_,'kick')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'お︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SOURCE_ASTIFEN')..') \nお︙ تـم قفـل التاك بالطرد ')
end,nil)   
...
send(msg.chat_id_, msg.id_,'お︙ تم قفل التكرار بالطرد')
elseif text == 'قفل التكرار' and Mod(msg) then 
database:hset(bot_id.."flooding:settings:"..msg.chat_id_ ,"flood",'del')  
send(msg.chat_id_, msg.id_,'お︙ تم قفل التكرار')
elseif text == 'قفل التكرار بالتقييد' and Mod(msg) then 
database:hset(bot_id.."flooding:settings:"..msg.chat_id_ ,"flood",'keed')  
send(msg.chat_id_, msg.id_,'お︙ تم قفل التكرار بالتقييد')
elseif text == 'قفل التكرار بالكتم' and Mod(msg) then 
database:hset(bot_id.."flooding:settings:"..msg.chat_id_ ,"flood",'mute')  
send(msg.chat_id_, msg.id_,'お︙ تم قفل التكرار بالكتم')
elseif text == 'فتح التكرار' and Mod(msg) then 
database:hdel(bot_id.."flooding:settings:"..msg.chat_id_ ,"flood")  
send(msg.chat_id_, msg.id_,'お︙ تم فتح التكرار')
end
...
dofile('DRAGON.lua')  
send(msg.chat_id_, msg.id_, 'お︙ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevSoFi(msg) then
database:del(bot_id..'GBan:User')
send(msg.chat_id_, msg.id_, '\nお︙ تم مسح قائمه العام')
return false
end
if text == ("قائمه العام") and DevSoFi(msg) then
local list = database:smembers(bot_id..'GBan:User')
t = "\nお︙ قائمة المحظورين عام \nٴ≪ـــــــــــــــــــــ𓆩 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴   𓆪ـــــــــــــــــــــ≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
send(msg.chat_id_, msg.id_, " お لا يمكنك حظر المطور الاساسي \n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " お لا تسطيع حظر البوت عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1805936474) then  
send(msg.chat_id_, msg.id_, " お لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1737072779) then  
send(msg.chat_id_, msg.id_, " お لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1815919869) then  
send(msg.chat_id_, msg.id_, " お لا تسطيع حظر مطور السورس عام")
database:sadd(bot_id..'GBan:User', result.sender_user_id_)
chat_kick(result.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},
function(arg,data) 
usertext = '\n お العضو お ['..data.first_name_..'](t.me/'..(data.username_ or 'DV_POWER1')..')'
status  = '\n お تم حظره عام من جروبات'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
if result.id_ == tonumber(1805936474) then
send(msg.chat_id_, msg.id_, " お لا يمكنك حظر  مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1737072779) then
send(msg.chat_id_, msg.id_, " お لا  يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1815919869) then
send(msg.chat_id_, msg.id_, " お لا  يمكنك حظر مبرمج السورس \n")
return false 
end
usertext = '\n お العضو お ['..result.title_..'](t.me/'..(username or 'DV_POWER1')..')'
status  = '\n お تم حظره عام من الجروبات'
texts = usertext..status
...
if tonumber(userid) == tonumber(1805936474) then  
send(msg.chat_id_, msg.id_, " お لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(1737072779) then  
send(msg.chat_id_, msg.id_, " お لا تسطيع حظر المطور السورس عام")
return false 
end
if tonumber(usrid)  == tonumber(1815919869) then
send(msg.chat_id_,msg.id_,"お لا تسطيع حظر عام المطور السورس عام ")
...
function start_function(extra, result, success)
if result.sender_user_id_ == tonumber(SUDO) then
send(msg.chat_id_, msg.id_, " お لا يمكنك كتم المطور الاساسي \n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " お لا تسطيع كتم البوت عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1805936474) then  
send(msg.chat_id_, msg.id_, " お لا تسطيع كتم مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1737072779) then  
send(msg.chat_id_, msg.id_, " お لا تسطيع كتم مبرمج السورس عام")
...
if result.id_ == tonumber(1737072779) then
send(msg.chat_id_, msg.id_, " お لا يمكنك كتم مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1815919869) then
send(msg.chat_id_, msg.id_, " お لا يمكنك كتم مبرمج السورس \n")
...
if tonumber(userid) == tonumber(1815919869) then  
send(msg.chat_id_, msg.id_, " お لا تسطيع كتم مبرمج السورس عام")
return false 
end
...
usertext = '\n お العضو お ['..data.first_name_..'](t.me/'..(data.username_ or 'DV_POWER1')..')'
status  = '\n お تم الغاء (الحظر-الكتم) عام من الجروبات'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
send(msg.chat_id_, msg.id_, "\nお︙ تم مسح قائمة المطورين  ")
end
if text == ("المطورين") and DevSoFi(msg) then
local list = database:smembers(bot_id..'Sudo:User')
t = "\nお︙ قائمة مطورين البوت \nٴ≪ـــــــــــــــــــــ𓆩 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴   𓆪ـــــــــــــــــــــ≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if Get_info then
local TextS = "\nお︙ اهلا بك في متجر ملفات استيفن\nお︙ ملفات السورس ↓\nٴ≪ـــــــــــــــــــــ𓆩 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴   𓆪ـــــــــــــــــــــ≫ٴ\n\n"
local TextE = "\nٴ≪ـــــــــــــــــــــ𓆩 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴   𓆪ـــــــــــــــــــــ≫ٴ\nお︙ علامة تعني { ✔️ } ملف مفعل\nお︙ علامة تعني { ✖ } ملف معطل\nお︙ قناة سورس استيفن ↓\n".."お︙ [اضغط هنا لدخول](t.me/SOURCE_ASTIFEN) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_,"お︙ لا يوجد اتصال من ال api \n") 
end
return false
end
end
...
send(msg.chat_id_, msg.id_,"お︙ عذرا الملف لايدعم سورس استيفن \n") 
end
return false
end
...
if file_bot then
io.close(file_bot)
t = "お︙ بالتاكيد تم تفعيل ملف → "..file.." \n"
else
t = "お︙ الملف » "..file.."\nお︙ تم تفعيل ملف \n"
end
local json_file, res = https.request("https://raw.githubusercontent.com/elagnbe34/elagbbe/main/File_Bot/"..file)
...
send(msg.chat_id_,msg.id_,"お︙ تم مسح الملفات")
return false
end
...
send(msg.chat_id_, msg.id_,'お︙ لا ����ستطيع استخدام البوت \n お︙ يرجى الاشتراك بالقناه اولا \n お︙ اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
function start_function(extra, result, success)
...
if #list == 0 then
t = "お︙ لا يوجد احد في قائمه المالك"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
Text = 'お︙ بالتاكيد تم تفعيل امر تحويل'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\nお︙ تم تعطيل امر تحويل'
else
Text = '\nお︙ بالتاكيد تم تعطيل امر تحويل'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_, '\nお︙ تم مسح المنشئين الاساسين')
return false
end
if text == 'المنشئين الاساسين' and CoSu(msg) then
local list = database:smembers(bot_id..'Basic:Constructor'..msg.chat_id_)
t = "\nお︙ قائمة المنشئين الاساسين \nٴ≪ـــــــــــــــــــــ𓆩 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴   𓆪ـــــــــــــــــــــ≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
send(msg.chat_id_, msg.id_,"お︙ حساب المنشئ محذوف")
return false  
end
local UserName = (b.username_ or "SRC-DRAGON")
send(msg.chat_id_, msg.id_,"お︙ منشئ الكروب » ["..b.first_name_.."](T.me/"..UserName..")")  
end,nil)   
end
end
end,nil)   
...
if num2 == 0 then
send(msg.chat_id_, msg.id_,"お︙ لا يوجد ادمنيه ليتم رفعهم") 
else
send(msg.chat_id_, msg.id_,"お︙ تمت ترقيه { "..num2.." } من الادمنيه") 
end
end,nil)   
end
if text == 'مسح الادمنيه' and Manager(msg) then
database:del(bot_id..'Mod:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, 'お︙ تم مسح الادمنيه')
end
...
send(msg.chat_id_, msg.id_,'お︙ تم تعطيل الرفع') 
return false
end
...
send(msg.chat_id_, msg.id_, 'お︙ تم مسح المنظفين')
end
...
send(msg.chat_id_, msg.id_,'お︙ تم تعطيل الطرد') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, "お︙ لا تسطيع طرد البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\nお︙ عذرا لا تستطيع طرد ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,'お︙  ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
return false  
end
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,'お︙ البوت ليس ادمن يرجى ترقيتي !') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\nお︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_ASTIFEN')..')'
...
send(msg.chat_id_, msg.id_, '\nお︙ عذرا لا تستطيع طرد ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"⚠| عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
send(msg.chat_id_, msg.id_, 'お︙ لا يوجد حساب بهاذا المعرف')
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
return false
...
send(msg.chat_id_, msg.id_, '\nお︙ عذرا لا تستطيع طرد ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
send(msg.chat_id_, msg.id_, 'お︙ تم مسح المميزين')
end
if text == ("المميزين") and Mod(msg) then
local list = database:smembers(bot_id..'Special:User'..msg.chat_id_)
t = "\nお︙ قائمة مميزين الكروب \nٴ≪ـــــــــــــــــــــ𓆩 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴   𓆪ـــــــــــــــــــــ≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\nお︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_ASTIFEN')..')'
status  = '\nお︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\nお︙ العضو » '..userid..''
...
send(msg.chat_id_, msg.id_, ' お تم مسح جميع المتوحدين')
end
if text == ("تاك للمتوحدين") and Mod(msg) then
local list = database:smembers(bot_id..'Mote:User'..msg.chat_id_)
t = "\n お قائمة متوحدين الجروب \n⩹━━━━━━ 𝗦??𝗨𝗥𝗖𝗘 𝗜𝗗𝗞 𖠱²² ━━━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."お المتوحد [@"..username.."]\n"
else
t = t..""..k.."お المتوحد `"..v.."`\n"
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n お العضو お ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n お تم رفع العضو متوحد في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n お العضو お ['..data.first_name_..'](t.me/'..(data.username_ or 'idek9')..')'
status  = '\n お تم تنزيل العضو متوحد في الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' お تم مسح جميع الزوجات')
end
if text == ("تاك للزوجات") and Mod(msg) then
local list = database:smembers(bot_id..'Mode:User'..msg.chat_id_)
t = "\n お قائمه زوجات الجروب \n⩹━━━━━━ ??𝗢𝗨𝗥𝗖𝗘 𝗜𝗗𝗞 𖠱²² ━━━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."お الزوجه [@"..username.."]\n"
else
t = t..""..k.."お الزوجه `"..v.."`\n"
end
end
if #list == 0 then
t = " お مع الاسف لا يوجد زوجه"
end
send(msg.chat_id_, msg.id_, t)
end
---------
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n お العضــو お ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n お تم رفع العضــو زوجه في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n お العضــو お ['..data.first_name_..'](t.me/'..(data.username_ or 'idek9')..')'
status  = '\n お تم تنزيل العضــو الزوجات من الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' お تم مسح جميع الكلاب')
end
...
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."お الكلب [@"..username.."]\n"
else
t = t..""..k.."お الكلب `"..v.."`\n"
end
end
if #list == 0 then
t = " お مع الاسف لا يوجد كلاب"
end
send(msg.chat_id_, msg.id_, t)
end
---------
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n お العضــو お ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n お تم رفع العضــو كلب في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n お العضــو お ['..data.first_name_..'](t.me/'..(data.username_ or 'idek9')..')'
status  = '\n お تم تنزيل العضــو كلب من الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' お تم تنزيل جميع حمير من الجروب')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n お العضو お ['..data.first_name_..'](t.me/'..(data.username_ or 'idek9')..')'
local  statuss  = '\n お تم رفع المتهم حمار بالجروب\n お الان اصبح حمار الجروب'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' お تم تنزيل جميع وتكات الجروب')
end
if text == ("تاك للوتكات") and Mod(msg) then
local list = database:smembers(bot_id..'Motte:User'..msg.chat_id_)
t = "\n お قائمة وتكات الجروب \n⩹━━━━━━ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗜𝗗𝗞 𖠱²² ━━━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."お الوتكه [@"..username.."]\n"
else
t = t..""..k.."お الوتكه `"..v.."`\n"
end
end
...
send(msg.chat_id_, msg.id_, ' お تم تنزيل جميع القرده بالجروب')
end
if text == ("تاك للقرود") and Mod(msg) then
local list = database:smembers(bot_id..'Motee:User'..msg.chat_id_)
t = "\n お قائمة القرود الجروب \n⩹━━━━━━ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗜𝗗𝗞 𖠱²² ━━━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."お القرد [@"..username.."]\n"
else
t = t..""..k.."お القرد `"..v.."`\n"
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n お العضو お ['..data.first_name_..'](t.me/'..(data.username_ or 'idek9')..')'
local  statuss  = '\n お تم رفع قرد في الجروب\n お تعال حبي استلم موزه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' お تم تنزيل جميع الارامل بالجروب')
end
if text == ("تاك للارامل") and Mod(msg) then
local list = database:smembers(bot_id..'Bro:User'..msg.chat_id_)
t = "\n お قائمة ارامل الجروب \n⩹━━━━━━ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗜𝗗𝗞 𖠱²² ━━━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."お الارمله [@"..username.."]\n"
else
t = t..""..k.."お الارمله `"..v.."`\n"
end
end
...
send(msg.chat_id_, msg.id_, ' お تم تنزيل جميع الخولات بالجروب')
end
if text == ("تاك للخولات") and Mod(msg) then
local list = database:smembers(bot_id..'Girl:User'..msg.chat_id_)
t = "\n お قائمة خولات الجروب \n⩹━━━━━━ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗜𝗗𝗞 𖠱²² ━━━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."お الخول [@"..username.."]\n"
else
t = t..""..k.."お الخول `"..v.."`\n"
end
end
...
send(msg.chat_id_, msg.id_, ' お تم تنزيل الازببه من الجروب')
end
if text == ("تاك الازببه") and Mod(msg) then
local list = database:smembers(bot_id..'Bakra:User'..msg.chat_id_)
t = "\n お قائمة البقرات الجروب \n⩹━━━━━━ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗜𝗗𝗞 𖠱²² ━━━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."お الزب [@"..username.."]\n"
else
t = t..""..k.."お الزب "..v.."\n"
end
end
if #list == 0 then
t = " お لا يوجد حد نايكه"
end
send(msg.chat_id_, msg.id_, t)
end
---------
...
send(msg.chat_id_, msg.id_, ' お تم تنزيل جميع المزز بالجروب')
end
...
send(msg.chat_id_, msg.id_, ' お تم تنزيل جميع االاكساس')
end
...
if database:get(bot_id..'Lock:kick'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,'お︙ تم تعطيل الحظر') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, "お︙ لا تسطيع حظر البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\nお︙ عذرا لا تستطيع حظر ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
if result.id_ then
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\nお︙ عذرا لا تستطيع حظر ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"お︙ عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
usertext = '\nお︙  المستخدم » ['..result.title_..'](t.me/'..(username or 'GLOBLA')..')'
status  = '\nお︙ تم حظره'
texts = usertext..status
chat_kick(msg.chat_id_, result.id_)
send(msg.chat_id_, msg.id_, texts)
...
if Can_or_NotCan(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\nお︙ عذرا لا تستطيع حظر ( '..Rutba(userid,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = userid, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,'お︙ ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then
send(msg.chat_id_, msg.id_, 'お︙ انا لست محظورآ \n') 
return false 
end
...
send(msg.chat_id_, msg.id_, 'お︙ تم مسح المكتومين')
end
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, "お︙ لا تسطيع كتم البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\nお︙ عذرا لا تستطيع كتم ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,'お︙ البوت ليس ادمن يرجى ترقيتي !') 
return false  
...
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\nお︙ عذرا لا تستطيع كتم ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"お︙ عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
return false 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\nお︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_ASTIFEN')..')'
status  = '\nお︙ تم كتم لمدة ~ { '..TextEnd[2]..' '..TextEnd[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
if Can_or_NotCan(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\nお︙ عذرا لا تستطيع كتم ( '..Rutba(userid,msg.chat_id_)..' )')
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,'お︙ البوت ليس ادمن يرجى ترقيتي !') 
return false  
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, "お︙ لا تسطيع تقييد البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\nお︙ عذرا لا تستطيع تقييد ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
if Can_or_NotCan(result.id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\nお︙ عذرا لا تستطيع تقييد ( '..Rutba(result.id_,msg.chat_id_)..' )')
return false 
end      
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\nお︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_ASTIFEN')..')'
status  = '\nお︙ تم تقييده لمدة ~ { '..TextEnd[2]..' '..TextEnd[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_..'&until_date='..tonumber(msg.date_+Time))
end
...
send(msg.chat_id_, msg.id_, '\nお︙ عذرا لا تستطيع تقييد ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\nお︙  العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_ASTIFEN')..')'
status  = '\nお︙  الايدي » `'..result.sender_user_id_..'`\nお︙  تم رفعه مشرف '
send(msg.chat_id_, msg.id_, usertext..status)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\nお︙  العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_ASTIFEN')..')'
status  = '\nお︙  الايدي » `'..result.sender_user_id_..'`\nお︙  تم تنزيله ادمن من الكروب بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
'\n⚙️┇𝙶𝚁𝙾𝚄𝙿 𝚂𝙴𝚃𝚃𝙸𝙽𝙶𝚂'..
'\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ '..
'\nお︙ اعدادات الكروب كتالي √↓'..
'\nءٴ≪ـــــــــــــــــــــ𓆩 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴   𓆪ـــــــــــــــــــــ≫ٴ'..
'\nお︙  علامة ال {🔓} تعني مفعل'..
'\nお︙  علامة ال {🔐} تعني معطل'..
'\nءٴ≪ـــــــــــــــــــــ𓆩 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴   𓆪ـــــــــــــــــــــ≫ٴ'..
'\nお︙  الروابط » { '..lock_links..
' }\n'..'お︙  المعرفات » { '..lock_user..
' }\n'..'お︙  التاك » { '..lock_hash..
' }\n'..'お︙  البوتات » { '..lock_bots..
' }\n'..'お︙  التوجيه » { '..lock_fwd..
' }\n'..'お︙  التثبيت » { '..lock_pin..
' }\n'..'お︙  الاشعارات » { '..lock_tagservr..
' }\n'..'お︙  الماركدون » { '..lock_mark..
' }\n'..'お︙  التعديل » { '..lock_edit..
' }\n'..'お︙  تعديل الميديا » { '..lock_edit_med..
' }\nءٴ≪ـــــــــــــــــــــ𓆩 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴   𓆪ـــــــــــــــــــــ≫ٴ'..
'\n'..'お︙  الكلايش » { '..lock_spam..
' }\n'..'お︙  الكيبورد » { '..lock_inlin..
' }\n'..'お︙  الاغاني » { '..lock_vico..
' }\n'..'お︙  المتحركه » { '..lock_gif..
' }\n'..'お︙  الملفات » { '..lock_file..
' }\n'..'お︙  الدردشه » { '..lock_text..
...
' }\n'..'お︙  التكرار » { '..flood..
' }\n'..'お︙  الترحيب » { '..welcome..
' }\n'..'お︙  عدد التكرار » { '..NUM_MSG_MAX..
' }\nءٴ≪ـــــــــــــــــــــ𓆩 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴   𓆪ـــــــــــــــــــــ≫ٴ'..
'\nお︙  علامة ال {🔓} تعني مفعل'..
'\nお︙  علامة ال {🔐} تعني معطل'..
'\nءٴ≪ـــــــــــــــــــــ𓆩 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴   𓆪ـــــــــــــــــــــ≫ٴ'..
'\n'..'お︙  امر صيح » { '..kickme..
' }\n'..'お︙  امر اطردني » { '..sehuser..
' }\n'..'お︙  امر مين ضافني » { '..addme..
' }\n'..'お︙  ردود المدير » { '..rdmder..
' }\n'..'お︙  ردود المطور » { '..rdsudo..
' }\n'..'お︙  الايدي » { '..idgp..
' }\n'..'お︙  الايدي بالصوره » { '..idph..
' }\n'..'お︙  الرفع » { '..setadd..
' }\n'..'お︙  الحظر » { '..banm..' }\n\nٴ≪ـــــــــــــــــــــ𓆩 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴   𓆪ـــــــــــــــــــــ≫ٴ\nお︙ قناة سورس استيفن ↓\n [ ❍ ┇𓆩 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴   𓆪.](t.me/SOURCE_ASTIFEN) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_,msg.id_,"お︙ عذرآ تم قفل التثبيت")  
return false  
end
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.reply_to_message_id_,disable_notification_ = 1},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_,"お︙ تم تثبيت الرساله")   
database:set(bot_id..'Pin:Id:Msg'..msg.chat_id_,msg.reply_to_message_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_,"お︙ انا لست ادمن هنا يرجى ترقيتي ادمن ثم اعد المحاوله")  
elseif data.message_ == "CHAT_NOT_MODIFIED" then
send(msg.chat_id_,msg.id_,"お︙ لا توجد رساله مثبته")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"お︙ ليست لدي صلاحية التثبيت يرجى التحقق من الصلاحيات")  
end
end,nil) 
end
...
if database:sismember(bot_id..'lock:pin',msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_,msg.id_,"お︙ عذرآ تم قفل الثبيت")  
return false  
end
tdcli_function({ID="UnpinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_,"お︙ تم الغاء تثبيت الرساله")   
...
send(msg.chat_id_,msg.id_,"お︙ حسنآ ارسل اليه الرابط الان")
...
send(msg.chat_id_, msg.id_,"お︙ تم تفعيل الصوره") 
return false  
end
end
...
send(msg.chat_id_, msg.id_,"お︙ تم تعطيل الصوره") 
return false end
end
if text == "الرابط" then 
...
send(msg.chat_id_,msg.id_,"お︙ تم مسح الرابط")           
...
send(msg.chat_id_, msg.id_,'お︙ ارسل لي الصوره') 
return false
end
...
send(msg.chat_id_, msg.id_,'お︙ تم ازالة صورة الكروب') 
end
return false  
end
...
send(msg.chat_id_, msg.id_,'お︙ ارسل الان الوصف')
end
return false  
end
...
t  = 'お︙ ارسل لي الترحيب الان'
tt = '\nお︙ تستطيع اضافة مايلي !\nお︙ دالة عرض الاسم »{`name`}\nお︙ دالة عرض المعرف »{`user`}'
...
GetWelcome = 'お︙ لم يتم تعيين ترحيب للكروب'
end 
...
send(msg.chat_id_, msg.id_,'お︙ تم تفعيل ترحيب الكروب') 
return false  
end
...
send(msg.chat_id_, msg.id_,'お︙ تم تعطيل ترحيب الكروب') 
return false  
end
if text == 'مسح الترحيب' or text == 'حذف الترحيب' then 
if Mod(msg) then
database:del(bot_id..'Get:Welcome:Group'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,'お︙ تم ازالة ترحيب الكروب') 
end
end
if text and text == "منع" and msg.reply_to_message_id_ == 0 and Manager(msg)  then       
send(msg.chat_id_, msg.id_,"お︙ ارسل الكلمه لمنعها")  
...
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"お︙ ارسل التحذير عند ارسال الكلمه")  
...
if test == "repp" then  
send(msg.chat_id_, msg.id_,"お︙ تم منع الكلمه مع التحذير")  
...
send(msg.chat_id_, msg.id_,"お︙ ارسل الكلمه الان")  
database:set(bot_id.."DRAGON1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."DRAGON1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test and test == "reppp" then   
send(msg.chat_id_, msg.id_,"お︙ تم الغاء منعها")  
database:del(bot_id.."DRAGON1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
send(msg.chat_id_, msg.id_,"お︙ تم مسح قائمه المنع")  
end
...
t = "\nお︙ قائمة المنع \nٴ≪ـــــــــــــــــــــ𓆩 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴   𓆪ـــــــــــــــــــــ≫ٴ\n"
for k,v in pairs(list) do  
localDRAGON_Msg = database:get(bot_id.."DRAGON1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..DRAGON_Msg.."}\n"    
end  
if #list == 0 then  
t = "お︙ لا يوجد كلمات ممنوعه"  
end  
send(msg.chat_id_, msg.id_,t)  
end  
...
send(msg.chat_id_,msg.id_,'お︙ تم الغاء حفظ كليشة المطور')
return false
end
database:set(bot_id..'TEXT_SUDO',text)
database:del(bot_id..'Set:TEXT_SUDO'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,'お︙ تم حفظ كليشة المطور')
return false
end
-----------------
...
send(msg.chat_id_, msg.id_, 'お︙ تم ازالة كليشة الايدي')
end
return false  
end 
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"お︙ تم الغاء تعين الايدي") 
...
send(msg.chat_id_, msg.id_,'お︙ تم تعين الايدي')    
end
...
if (c - x) == 0 then
send(msg.chat_id_, msg.id_, "お︙ لا توجد بوتات في الكروب")
else
local t = 'お︙ عدد البوتات هنا >> {'..c..'}\nお︙ عدد البوتات التي هي ادمن >> {'..x..'}\nお︙ تم طرد >> {'..(c - x)..'} من البوتات'
send(msg.chat_id_, msg.id_,t) 
end 
end,nil)  
end   
...
if #admins == i then 
local a = '\nٴ≪ـــــــــــــــــــــ𓆩 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴   𓆪ـــــــــــــــــــــ≫ٴ\nお︙ عدد البوتات التي هنا >> {'..n..'} بوت\n'
local f = 'お︙ عدد البوتات التي هي ادمن >> {'..t..'}\nお︙ ملاحضه علامة ال (✯) تعني ان البوت ادمن \n'
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_, "お︙ تم الغاء حفظ القوانين") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
return false  
end 
database:set(bot_id.."Set:Rules:Group" .. msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,"お︙ تم حفظ قوانين الكروب") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
end  
...
send(msg.chat_id_,msg.id_,"お︙ ارسل لي القوانين الان")  
end
end
if text == 'مسح القوانين' or text == 'حذف القوانين' then  
if Mod(msg) then
send(msg.chat_id_, msg.id_,"お︙ تم ازالة قوانين الكروب")  
...
send(msg.chat_id_, msg.id_,"お︙ لا توجد قوانين")   
end    
end
...
send(msg.chat_id_, msg.id_,'お︙ تم طرد المحذوفين')
end,nil)
end
end
...
if #list == 0 then
send(msg.chat_id_, msg.id_,'お︙ لا توجد صلاحيات مضافه')
return false
end
t = "\nお︙ قائمة الصلاحيات المضافه \nٴ≪ـــــــــــــــــــــ𓆩 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴   𓆪ـــــــــــــــــــــ≫ٴ\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_, "お︙ ارسل نوع الرتبه \nお︙ {عـضـو -- ممـيـز -- ادمـن -- مـديـر}") 
end
...
send(msg.chat_id_, msg.id_, "*お︙ تم مسح الصلاحيه *\n") 
end
...
if text == 'مدير' then
if not Constructor(msg) then
send(msg.chat_id_, msg.id_"*お︙ تستطيع اضافه صلاحيات {ادمن - مميز - عضو} \nお︙ ارسل الصلاحيه مجددا*\n") 
return false
end
end
if text == 'ادمن' then
if not Manager(msg) then 
send(msg.chat_id_, msg.id_,"*お︙ تستطيع اضافه صلاحيات {مميز - عضو} \nお︙ ارسل الصلاحيه مجددا*\n") 
return false
end
end
if text == 'مميز' then
if not Mod(msg) then
send(msg.chat_id_, msg.id_,"*お︙  تستطيع اضافه صلاحيات {عضو} \nお︙ ارسل الصلاحيه مجددا*\n") 
return false
end
end
...
send(msg.chat_id_, msg.id_, "お︙ تـم اضـافـه الامـر") 
database:del(bot_id.."Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\nお︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'SOURCE_ASTIFEN')..')'..'\nお︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'お︙ تم مسح رسائلك'  )  
...
send(msg.chat_id_, msg.id_,'お︙ عدد رسائلك » { '..database:get(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_)..'}' ) 
end 
...
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_,"お︙ ارسل لي الاسم الان ")  
end
return false
end

if text == ""..(database:get(bot_id..'Name:Bot') or 'استيفن').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'استيفن')
localDRAGON_Msg = {
'عمغي 🥺💕.',
...
send(msg.chat_id_, msg.id_,'お︙ الاذاعه معطله من قبل المطور الاساسي')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"お︙ ليست لدي صلاحية تغير اسم الكروب")  
else
sebd(msg.chat_id_,msg.id_,'お︙ تم تغيير اسم الكروب الى {['..Name..']}')  
end
end,nil) 
end
...
send(msg.chat_id_, msg.id_,"お︙ لا تستطيع تنزيل المطور الاساسي")
return false 
end
...
send(msg.chat_id_, msg.id_,"\nお︙ تم تنزيل الشخص من الرتب التاليه \nお︙ { "..dev..''..crr..''..cr..''..own..''..mod..''..mn..''..vip.." } \n")
else
send(msg.chat_id_, msg.id_,"\nお︙  عذرا العضو لايملك رتبه \n")
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀.',url="t.me/SOURCE_ASTIFEN"}},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_, msg.id_,'℘︙لا يمكنني تعديل  او وضع لقب ليس لدي صلاحيه\nお︙قم بترقيتي جميع الصلاحيات او صلاحية اضافه مشرف ') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_ASTIFEN')..') '
...
function start_function(extra, result, success)
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,'お︙ البوت ليس مشرف يرجى ترقيتي !') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\nお︙  العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_ASTIFEN')..')'
status  = '\nお︙  الايدي » `'..result.sender_user_id_..'`\nお︙  تم حذف لقبه من الكروب'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
database:set(bot_id.."SOURCE_ASTIFEN:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."SOURCE_ASTIFEN:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."SOURCE_ASTIFEN:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."SOURCE_ASTIFEN:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"℘︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."SOURCE_ASTIFEN:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."SOURCE_ASTIFEN:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس استيفن يعني لو بكتهن راح اعرفك انت الاخذتهن
...
------------------------------------------------------------------------
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'استيفن').." غادر" or text == 'بوت غادر' then  
if Sudo(msg) and not database:get(bot_id..'Left:Bot'..msg.chat_id_)  then 
tdcli_function ({ID = "ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=bot_id,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
send(msg.chat_id_, msg.id_,'お︙ تم مغادرة الكروب') 
database:srem(bot_id..'Chek:Groups',msg.chat_id_)  
end
return false  
end
...
Text = 'お︙ تم تفعيل مغادرة البوت'
database:del(bot_id..'Left:Bot'..msg.chat_id_)  
else
Text = 'お︙ بالتاكيد تم تفعيل مغادرة البوت'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل المغادره' and DevSoFi(msg) then  
if not database:get(bot_id..'Left:Bot'..msg.chat_id_) then
Text = 'お︙ تم تعطيل مغادرة البوت'
database:set(bot_id..'Left:Bot'..msg.chat_id_,true)   
else
Text = 'お︙ بالتاكيد تم تعطيل مغادرة البوت'
end
send(msg.chat_id_, msg.id_, Text) 
end
...
Text = '\nお︙ تم تعطيل ردود المدير' 
else
Text = '\nお︙ بالتاكيد تم تعطيل ردود المدير'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\nお︙ تم تفعيل ردود المطور' 
else
Text = '\nお︙ بالتاكيد تم تفعيل ردود المطور'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\nお︙ تم تعطيل ردود المطور' 
else
Text = '\nお︙ بالتاكيد تم تعطيل ردود المطور'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\nお︙ تم تفعيل الايدي بالصور' 
else
Text = '\nお︙ بالتاكيد تم تفعيل الايدي بالصوره'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
if not database:get(bot_id..'Bot:Id:Photo'..msg.chat_id_)  then
database:set(bot_id..'Bot:Id:Photo'..msg.chat_id_,true) 
Text = '\nお︙ تم تعطيل الايدي بالصوره' 
else
Text = '\nお︙ بالتاكيد تم تعطيل الايدي بالصوره'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_,'お︙ ايديه ~⪼ '..iduser..'\nお︙ معرفه ~⪼ '..username..'\nお︙ رتبته ~⪼ '..rtp..'\nお︙ تعديلاته ~⪼ '..edit..'\nお︙ نقاطه ~⪼ '..NUMPGAME..'\nお︙ جهاته ~⪼ '..Contact..'\nお︙ رسائله ~⪼ '..Msguser..'')
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
end
...
send(msg.chat_id_, msg.id_,'お︙ المعرف غير صحيح ')
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
end
if text == 'رتبتي' then
local rtp = Rutba(msg.sender_user_id_,msg.chat_id_)
send(msg.chat_id_, msg.id_,'お︙ رتبتك في البوت » '..rtp)
end
if text == "اسمي"  then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(extra,result,success)
if result.first_name_  then
first_name = 'お︙ اسمك الاول » {`'..(result.first_name_)..'`}'
else
first_name = ''
end   
if result.last_name_ then 
last_name = 'お︙ اسمك الثاني » {`'..result.last_name_..'`}' 
else
last_name = ''
end      
...
if text == 'ايديي' then
send(msg.chat_id_, msg.id_,'お︙ ايديك » '..msg.sender_user_id_)
end
if text == 'الرتبه' and tonumber(msg.reply_to_message_id_) > 0 then
function start_function(extra, result, success)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_ASTIFEN')..')'
local iduser = result.sender_user_id_
...
local username = ('[@'..data.username_..']' or 'لا يوجد')
local iduser = result.sender_user_id_
send(msg.chat_id_, msg.id_,'お︙ الايدي » ('..iduser..')\nお︙ المعرف » ('..username..')\nお︙ الرتبه » ('..rtp..')\nお︙ نوع الكشف » بالرد')
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
end
...
if msg.can_be_deleted_ == false then 
send(msg.chat_id_,msg.id_,"お︙ البوت ليس ادمن \n") 
return false  
end 
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,ta) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
local sofi = 'お︙ عدد الادمنيه : '..data.administrator_count_..
'\n\nお︙ عدد المطرودين : '..data.kicked_count_..
'\n\nお︙ عدد الاعضاء : '..data.member_count_..
'\n\nお︙ عدد رسائل الكروب : '..(msg.id_/2097152/0.5)..
'\n\nお︙  اسم الكروب : ['..ta.title_..']'
...
send(msg.chat_id_, msg.id_, '\nお︙ عذرا لا استطيع طرد ( '..Rutba(msg.sender_user_id_,msg.chat_id_)..' )')
return false
end
...
send(msg.chat_id_, msg.id_,'お︙ عذرا لا استطيع طرد ادمنية الكروب') 
return false  
end
if data and data.ID and data.ID == 'Ok' then
send(msg.chat_id_, msg.id_,'お︙ تم طردك من الكروب') 
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = msg.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
return false
end
end,nil)   
else
send(msg.chat_id_, msg.id_,'お︙ تم تعطيل امر اطردني') 
end
end
...
send(msg.chat_id_, msg.id_,'お︙ المعرف غلط ') 
return false  
end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.ID == "Channel" then
send(msg.chat_id_, msg.id_,'お︙ لا استطيع اصيح معرف قنوات') 
return false  
end
if result.type_.user_.type_.ID == "UserTypeBot" then
send(msg.chat_id_, msg.id_,'お︙ لا استطيع اصيح معرف بوتات') 
return false  
end
...
if result.id_ then
send(msg.chat_id_, msg.id_,'お︙ تعال حبي يصيحونك بل كروب [@'..username..']') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
else
send(msg.chat_id_, msg.id_,'お︙ تم تعطيل امر صيح') 
end
return false
end
...
send(msg.chat_id_, msg.id_,'お︙ انت منشئ الكروب') 
return false
end
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = 'お︙ الشخص الذي قام باضافتك هو » '..Name
sendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
end,nil)
else
send(msg.chat_id_, msg.id_,'お︙ انت دخلت عبر الرابط لتلح') 
end
end,nil)
else
send(msg.chat_id_, msg.id_,'お︙ تم تعطيل امر مين ضافني') 
end
end

if text == 'تفعيل ضافني' and Manager(msg) then   
if database:get(bot_id..'Added:Me'..msg.chat_id_) then
Text = 'お︙ تم تفعيل امر مين ضافني'
database:del(bot_id..'Added:Me'..msg.chat_id_)  
else
Text = 'お︙ بالتاكيد تم تفعيل امر مين ضافني'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\nお︙ تم تعطيل امر مين ضافني'
else
Text = '\nお︙ بالتاكيد تم تعطيل امر مين ضافني'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل صيح' and Manager(msg) then   
if database:get(bot_id..'Seh:User'..msg.chat_id_) then
Text = 'お︙ تم تفعيل امر صيح'
database:del(bot_id..'Seh:User'..msg.chat_id_)  
else
Text = 'お︙ بالتاكيد تم تفعيل امر صيح'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
database:del(bot_id..'Mod:User'..msg.chat_id_)
database:del(bot_id..'Special:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\nお︙ تم تنزيل الكل من الرتب الاتيه \nお︙ المميزين ، الادمنيه ، المدراء ، المنشئين \n')
end
...
Text = '\nお︙ بالتاكيد تم تعطيل امر صيح'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل اطردني' and Manager(msg) then   
if database:get(bot_id..'Cick:Me'..msg.chat_id_) then
Text = 'お︙ تم تفعيل امر اطردني'
database:del(bot_id..'Cick:Me'..msg.chat_id_)  
else
Text = 'お︙ بالتاكيد تم تفعيل امر اطردني'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\nお︙ تم تعطيل امر اطردني'
else
Text = '\nお︙ بالتاكيد تم تعطيل امر اطردني'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "صورتي"  then
...
if not my_ph then
send(msg.chat_id_, msg.id_,"お︙ الصوره معطله") 
return false  
end
local function getpro(extra, result, success)
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_,"お︙ عدد صورك ~⪼ "..result.total_count_.." صوره‌‏", msg.id_, msg.id_, "md")
else
...
local rtpg = rtpa
local sofia = {
"お︙ اروح فـدوه للـحلوين",
"お︙ حلوة حبيبي معليك بالمضغوطين",
"お︙ جهرتك منورة ",
"お︙ هاي شكد حلو انتة",
"お︙ اصلا صوفي احلئ",
"お︙ اصلا روظي احلئ",
...
if result.status_.ID == "UserStatusRecently" and result.profile_photo_ ~= false then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, sofi.photos_[0].sizes_[1].photo_.persistent_id_,''..rdphoto..'\nお︙ ايديك ~⪼ '..msg.sender_user_id_..'\nお︙ معرفك ~⪼ '..username..'\nお︙ رتبتك ~⪼ '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\nお︙ موقعك ~⪼ '..rtpa..'\nお︙ تفاعلك ~⪼ '..Total_Msg(Msguser)..'\nお︙ رسائلك ~⪼ '..Msguser..'\nお︙ نسبه تفاعلك ~⪼ '..string.sub(nspatfa, 1,5)..' %\nお︙ السحكات ~⪼ '..edit..'\nお︙ نقاطك ~⪼ '..NUMPGAME..'\n')
else 
if result.status_.ID == "UserStatusEmpty" and result.profile_photo_ == false then
send(msg.chat_id_, msg.id_,'[\nお︙ ايديك ~⪼ '..msg.sender_user_id_..'\nお︙ معرفك ~⪼ '..username..'\nお︙ رتبتك ~⪼ '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\nお︙ موقعك ~⪼ '..rtpa..'\nお︙ تفاعلك ~⪼ '..Total_Msg(Msguser)..'\nお︙ رسائلك ~⪼ '..Msguser..'\nお︙ نسبه  تفاعلك ~⪼ '..string.sub(nspatfa, 1,5)..' %\nお︙ السحكات ~⪼ '..edit..'\nお︙ نقاطك ~⪼ '..NUMPGAME..']\n')
else
send(msg.chat_id_, msg.id_, '\nお︙ الصوره ~⪼ ليس لديك صور في حسابك'..'[\nお︙ ايديك ~⪼ '..msg.sender_user_id_..'\nお︙ معرفك ~⪼ '..username..'\nお︙ رتبتك ~⪼ '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\nお︙ موقعك ~⪼ '..rtpa..'\nお︙ تفاعلك ~⪼ '..Total_Msg(Msguser)..'\nお︙ رسائلك ~⪼ '..Msguser..'\nお︙ نسبه تفاعلك ~⪼ '..string.sub(nspatfa, 1,5)..' %\nお︙ السحكات ~⪼ '..edit..'\nお︙ نقاطك ~⪼ '..NUMPGAME..']\n')
end 
end
end
else
...
if Num == 0 then 
Text = 'お︙  ليس لديك سحكات'
else
Text = 'お︙ عدد سحكاتك *» { '..Num..' } *'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "مسح سحكاتي" or text == "حذف سحكاتي" then  
send(msg.chat_id_, msg.id_,'お︙ تم مسح سحكاتك'  )  
database:del(bot_id..'edits'..msg.chat_id_..msg.sender_user_id_)
end
if text == "مسح جهاتي" or text == "حذف جهاتي" then  
send(msg.chat_id_, msg.id_,'お︙ تم مسح جهاتك'  )  
...
if Num == 0 then 
Text = 'お︙ لم تقم بأضافه احد'
else
Text = 'お︙ عدد جهاتك *» { '..Num..' } *'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
if #pv == i then 
if sendok == 0 then
send(msg.chat_id_, msg.id_,'お︙  لا يوجد مشتركين وهميين في البوت \n')   
else
local ok = #pv - sendok
send(msg.chat_id_, msg.id_,'お︙ عدد المشتركين الان » ( '..#pv..' )\n- تم ازالة » ( '..sendok..' ) من المشتركين\n- الان عدد المشتركين الحقيقي » ( '..ok..' ) مشترك \n')   
end
end
end,nil)
end,nil)
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,'お︙  لا يوجد كروبات وهميه في البوت\n')   
else
localDRAGON = (w + q)
local sendok = #group -DRAGON
if q == 0 then
...
send(msg.chat_id_, msg.id_,'お︙ عدد المجموعـات الان » { '..#group..' }'..DRAGONk..''..DRAGON..'\n*- الان عدد المجموعـات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
-- vardump(data) 
DRAGONdx(msg.chat_id_, msg.id_, 'お︙ ايدي المجموعة » ( '..msg.chat_id_..' )\nお︙ عدد الادمنيه » ( *'..data.administrator_count_..' )*\nお︙ عدد المحظورين » ( *'..data.kicked_count_..' )*\nお︙ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
send(msg.chat_id_, msg.id_,"お︙ تم اضافة له {"..numadded..'} من الرسائل')  
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, 'お︙ ارسل لي عدد الرسائل الان') 
return false
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, 'お︙ ارسل لي عدد النقاط التي تريد اضافتها') 
return false
end
------------------------------------------------------------------------
if text and text:match("^اضف نقاط (%d+)$") and msg.reply_to_message_id_ ~= 0 and Constructor(msg) then
...
send(msg.chat_id_, msg.id_,"お︙ تم اضافة له {"..Num..'} من النقاط')  
end
...
if Num == 0 then 
Text = 'お︙ لم تلعب اي لعبه للحصول على نقاط'
else
Text = 'お︙ عدد نقاطك التي ربحتها هيه *» { '..Num..' } نقاط *'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_,msg.id_,"\n*お︙ لا استطيع البيع اقل من 1 *") 
return false 
end
if tonumber(database:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)) == tonumber(0) then
send(msg.chat_id_,msg.id_,'お︙ ليس لديك نقاط في الالعاب\nお︙ اذا كنت تريد ربح نقاط \nお︙ ارسل الالعاب وابدأ اللعب ! ') 
else
local NUM_GAMES = database:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)
if tonumber(NUMPY) > tonumber(NUM_GAMES) then
send(msg.chat_id_,msg.id_,'\nお︙ ليس لديك نقاط في هذه لعبه \nお︙ لزيادة نقاطك في اللعبه \nお︙ ارسل الالعاب وابدأ اللعب !') 
return false 
end
local NUMNKO = (NUMPY * 50)
database:decrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,NUMPY)  
database:incrby(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_,NUMNKO)  
send(msg.chat_id_,msg.id_,'お︙ تم خصم *» { '..NUMPY..' }* من نقاطك \nお︙ وتم اضافة* » { '..(NUMPY * 50)..' } رساله الى رسالك *')
end 
return false 
end
...
send(msg.chat_id_,msg.id_,'\nお︙ اهلا عزيزي البوت هنا ادمن'..'\nお︙ وصلاحياته هي ↓ \nٴ━━━━━━━━━━'..'\nお︙ تغير معلومات الكروب ↞ ❴ '..info..' ❵'..'\nお︙ حذف الرسائل ↞ ❴ '..delete..' ❵'..'\nお︙ حظر المستخدمين ↞ ❴ '..restrict..' ❵'..'\nお︙ دعوة مستخدمين ↞ ❴ '..invite..' ❵'..'\nお︙ تثبيت الرسائل ↞ ❴ '..pin..' ❵'..'\nお︙ اضافة مشرفين جدد ↞ ❴ '..promote..' ❵')   
end
end
end
...
send(msg.chat_id_, msg.id_,"お︙ تم تغير رد المطور الى » "..Teext)
end
...
if not Mod(msg) then
send(msg.chat_id_, msg.id_,'おهاذا الامر خاص بالادمنيه\nおغير مسموح لك ب هذا الامر')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
send(msg.chat_id_, msg.id_,'おلا تستطيع استخدام البوت \n おيرجى الاشتراك بالقناه اولا \n おاشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
local Text =[[
اتبع الازرار تحت ⇣
واستمتع للأوامر 🕹️
[お 𝗦𝗢𝗨𝗥𝗖𝗘  𖠱²² お](t.me/SOURCE_ASTIFEN)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if not Constructor(msg) then
send(msg.chat_id_, msg.id_,'お︙ هاذا الامر خاص بالادمنيه\nお︙ ارسل {م10} لعرض اوامر الاعضاء')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local MRSoOoFi = database:get(bot_id.."AL:AddS0FI:stats") or "لم يتم التحديد"
...
{
{text = '𝐃𝐑𝐀𝐆𝐎𝐍 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/SOURCE_ASTIFEN"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_, t..'⩹━━━━━━ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴  ━━━━━━⩺\n℘︙ ➫ .[ ❍ ┇𓆩 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴   𓆪. ](t.me/SOURCE_ASTIFEN)➤ ')
end
...
🍁الاشعارات
⩹━━━━━━ 𝚂𝙾??𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴  ━━━━━━⩺
[🍁𝗦𝗢𝗨𝗥𝗖𝗘 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴  🍁](t.me/SOURCE_ASTIFEN)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
🍁صورتي 
⩹━━━━━━ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴  ━━━━━━⩺
[🍁𝗦𝗢𝗨𝗥𝗖𝗘 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴  ⚡️](t.me/SOURCE_ASTIFEN)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
⩹━━━━━━ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴  ━━━━━━⩺
[✪ ????𝗨𝗥𝗖?? 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴  ✪](t.me/SOURCE_ASTIFEN)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
🗯️التاريخ
⩹━━━━━━ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴  ━━━━━━⩺
[🗯️ 𝗦𝗢𝗨𝗥𝗖𝗘 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴  🗯️](t.me/SOURCE_ASTIFEN)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
💥تحب هذا
⩹━━━━━━ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴  ━━━━━━⩺
[💥  𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀💥 ](t.me/SOURCE_ASTIFEN)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
local Teext =[[
اتبع الازرار تحت 
واستمتع للأوامر سورس استيفن 🕹️
[✨ 𝗦𝗢𝗨𝗥𝗖𝗘 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴  ✨](t.me/mmmmm_70)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = '𝗦𝗢𝗨𝗥𝗖𝗘  𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴  ', url="t.me/SOURCE_ASTIFEN"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
{
{text = '𝗦𝗢𝗨𝗥𝗖𝗘  𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴  ', url="t.me/mmmmm_70"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_,'お︙ تم حذف الامر')  
else
send(msg.chat_id_, msg.id_,'お︙ لا يوجد امر بهاذا الاسم')  
end
...
send(msg.chat_id_, msg.id_, 'お︙ تم تعطيل اوامر التحشيش')
database:set(bot_id.."Fun_Bots:"..msg.chat_id_,"true")
end
if (text and text == "تفعيل اوامر التحشيش") then 
send(msg.chat_id_, msg.id_, ' お︙ تم تفعيل اوامر التحشيش')
database:del(bot_id.."Fun_Bots:"..msg.chat_id_)
end
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'استيفن')
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/SOURCE_ASTIFEN)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/SOURCE_ASTIFEN)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/SOURCE_ASTIFEN)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/SOURCE_ASTIFEN)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/SOURCE_ASTIFEN)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂お](t.me/SOURCE_ASTIFEN)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/SOURCE_ASTIFEN)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/SOURCE_ASTIFEN)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/SOURCE_ASTIFEN)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/SOURCE_ASTIFEN)') 
return false
end
...
{{text = 'お ❪SＯＵＲＣＥ❫ お', url="t.me/SOURCE_ASTIFEN"}},
}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))  
end
...
if text == 'اوس اوس' or text == 'مبرمج السورس' then  
local Text = [[  
お اقـــمــــد مــن الـــقــمــدان يـــآروحـــي お
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = 'おمـبرمج السـورسお',url="t.me/OSDDR"}},  
...
if text == 'جنا' or text == 'رولين' or text == 'رورو' then
local Text = [[
𓆩 روح قلب الكومندا التونز ??
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'المطور السورس',url="t.me/Rolen0"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == '' الاجنبي == '' then  
local Text = [[  
مبرمج السورس يروحي
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = 'Dev agnaby',url="t.me/Ure_rat"}},  

}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Ure_rat&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == ''كومندا التونز == '' then  
local Text = [[  
مبرمج السورس يروحيي
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = 'كومندا تونز يروحي',url="t.me/Elkomanda_ALTONZ"}},  

}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Elkomanda_ALTONZ&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'بوت' then 
local rtp = Rutba(msg.sender_user_id_,msg.chat_id_) 
send(msg.chat_id_, msg.id_,' شو عم تقول انت الـ بوت '..rtp..' 🥺❤\n.') 
end
...
send(msg.chat_id_,0,''..t..'\nٴ≪ـــــــــــــــــــــ𓆩 SOURCE ASTIFEN?? 𓏴   𓆪ـــــــــــــــــــــ≫ٴ\nお︙ تم التعديل على الميديا\nお︙ الشخص الي قام بالتعديل\nお︙ ايدي الشخص ◂ '..result.sender_user_id_..'\nお︙ معرف الشخص»{ '..users..' }') 
end,nil)
...
------------------------------------------------------------------------
localDRAGONAbot = database:get(bot_id.."DRAGON1:Add:Filter:Rp2"..text..result.chat_id_)   
ifDRAGONAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"お︙ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\nお︙ ["..DRAGONAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
localDRAGON1_Msg = database:get(bot_id.."DRAGON1:Add:Filter:Rp2"..text..result.chat_id_)   
ifDRAGON1_Msg then    
send(msg.chat_id_, msg.id_,"お︙ "..DRAGON1_Msg)

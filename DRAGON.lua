...
if res ~= 200 then
print('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ ┉  ┉ ┉ ┉ ┉≫ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naٴ≪┉ ┉ ┉ ┉ ┉ ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ ┉  ┉ ┉ ┉ ┉≫ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴ≪┉ ┉ ┉ ┉ ┉ ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ ┉  ┉ ┉ ┉ ┉≫ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Ahmedososs/ELGAMDEN/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,bot_id,1366055467}   
...
var = 'مبرمج اجنبي اليكس '
if tonumber(user_id) == tonumber(1737072779) then  
var ='مبرمج الكومندا التونز  '
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
elseif database:sismember(bot_id.."Dev:SoFi:2", user_id) then
var = "المطور الاساسي²"  
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'ميكي'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local UserName = (data.username_ or "ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos")
local NameUser = "お بواسطه » ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "お اسم المستخدم » ["..data.first_name_.."](T.me/"..UserName..")"
if status == "reply" then
send(msg.chat_id_, msg.id_,NameUserr.."\n"..text)
return false
end
else
send(msg.chat_id_, msg.id_,"お الحساب محذوف يرجى استخدام الامر بصوره صحيحه")
end
end,nil)   
end 
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ")  
...
if text == "الغاء" or text == "الغاء お" then   
...
echo '*—————ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ——————~*\nお✔{ الــدخــول } ⇎\n*»» '`whoami`'*'
echo '*—————ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ——————~*\nお✔{ مـده تـشغيـل الـسـيـرفـر }⇎\n*»» '"$uptime"'*'
]]):read('*all'))  
end

if text == 'تحديث السورس ' and DevSoFi(msg) then 
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/Ahmedososs/ELGAMDEN/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,' お تم تحديث السورس \n お لديك اخر اصدار لسورس ميكي\n お الاصدار » { v 1.5}')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' お اصدار سورس ميكي \n お الاصدار »{ v 1.5}')
end
if text == 'اجنبي اليكس مبرمج السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[]()
]] 
...
{{text = '𓆩ElAgNbE AlX 𓆪',url="t.me/Ure_rat"}},
} 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/mmmmm_70"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[TWL](t.me/TWASOL_ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝBOT)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𓆩𝗧𝘄𝗮𝘀𝗼𝗹𓆪', url="t.me/TWASOL_ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝBOT"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_,'• اهلا بك عزيزي お •\n• لايمكنك استخدام البوت お •\n• عليك الاشتراك في القناة お •\n• اشترك اولا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
...
local ok = #pv - sendok
send(msg.chat_id_, msg.id_,'お عدد المشتركين الان » ( '..#pv..' )\nお تم ازالة » ( '..sendok..' ) من المشتركين\nお  الان عدد المشتركين الحقيقي » ( '..ok..' ) مشترك \n')   
end
end
end,nil)
end,nil)
...
DRAGON = '\nお تم ازالة » { '..q..' } كروبات من البوت'
end
if w == 0 then
DRAGONk = ''
else
DRAGONk = '\nお تم ازالة » {'..w..'} كروب لان البوت عضو'
end
send(msg.chat_id_, msg.id_,'お  عدد الجروبات الان » { '..#group..' }'..DRAGONk..''..DRAGON..'\nお  الان عدد الجروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
usertext = '\n お العضو » ['..result.title_..'](t.me/'..(username or 'ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos')..')'
status  = '\n お تم ترقيته مطور'
...
usertext = '\n お العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos')..')'
status  = '\n お تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' お العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos')..') \n お '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_, msg.id_,' お تم تغيير صورة الجروب')
end
end, nil) 
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
end   
...
send(msg.chat_id_, msg.id_,' お تم تغيير وصف الجروب')
return false  
end 
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' お تم حفظ ترحيب الجروب')
return false   
end
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_,0," お العضو : {["..data.first_name_.."](T.ME/ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos)}\n お ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " お عذرا » {["..data.first_name_.."](T.ME/ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos)}\n お عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_,' お عدد اعضاء الجروب قليله يرجى جمع >> {'..(database:get(bot_id..'Num:Add:Bot') or 0)..'} عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' お بالتأكيد تم تفعيل الجروب')
else
sendText(msg.chat_id_,'\n お بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n お تم تفعيل الجروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
'\n お بواسطة {'..Name..'}'..
'\n お ايدي الجروب {'..IdChat..'}'..
'\n お اسم الجروب {['..NameChat..']}'..
'\n お عدد اعضاء الجروب *{'..NumMember..'}*'..
'\n お الرابط {['..LinkGp..']}'
...
send(msg.chat_id_, msg.id_,' お بالتأكيد تم تعطيل الجروب')
else
sendText(msg.chat_id_,'\n お بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n お تم تعطيل الجروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' お تم تفعيل الجروب')
else
sendText(msg.chat_id_,'\n お بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n お تم تفعيل الجروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'Chek:Groups',msg.chat_id_)  
...
send(msg.chat_id_, msg.id_,' お تم تعيين عدد الاعضاء سيتم تفعيل الجروبات التي اعضائها اكثر من  >> {'..Num..'} عضو')
end
if text == 'تحديث السورس' and DevSoFi(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
if text and text:match("^وضع قناة الاشتراك お$") and DevSoFi(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' お حسنآ ارسل لي معرف القناة')
return false  
end
...
send(msg.chat_id_, msg.id_, 'お تم تفعيل الاضافات')
database:set(bot_id.."AL:AddS0FI:stats","✔")
end
if text == "تعطيل الاضافات" and SudoBot(msg) then
send(msg.chat_id_, msg.id_, 'お تم تعطيل الاضافات')
database:set(bot_id.."AL:AddS0FI:stats","✖")
end
...
send(msg.chat_id_, msg.id_, 'お تم كتم الاسم '..BlNe)
...
send(msg.chat_id_, msg.id_, 'お تم الغاء كتم الاسم '..delBn)
...
texts = "お تم مسح الاسماء المكتومه "
send(msg.chat_id_, msg.id_, texts)
end
...
t = "\nお قائمة الاسماء المكتومه \nٴ≪┉ ┉ ┉ ┉ ┉ ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ ┉  ┉ ┉ ┉ ┉≫ٴ \n"
for k,v in pairs(All_name) do
t = t..""..k.."- (["..v.."])\n"
end
if #All_name == 0 then
t = "お لا يوجد اسماء مكتومه"
end
send(msg.chat_id_, msg.id_, t)
end
end
if text == "تفعيل كتم الاسم" and Constructor(msg) and database:get(bot_id.."AL:AddS0FI:stats") == "✔" then
send(msg.chat_id_, msg.id_, 'お تم التفعيل الاسماء المكتومه')
...
send(msg.chat_id_, msg.id_, 'お تم تعطيل الاسماء المكتومه')
...
send(msg.chat_id_, msg.id_,'お تم تعيين '..teh..' كتوحيد للمجموعه')
...
send(msg.chat_id_, msg.id_,'お تم تعين  '..nump..' عدد الكتم')
...
send(msg.chat_id_, msg.id_, 'お تم تعطيل التوحيد')
...
send(msg.chat_id_, msg.id_, "お عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos")..")\nお عليك وضع التوحيد ⪼ {"..database:get(bot_id.."DRAGON:teh"..msg.chat_id_).."} بجانب اسمك\nお عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
local Text = [[
╭━━━━━❲☆ELAGNB AlEx☆❳━━━━━╮
❲𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴  ᎪՏͲᎥҒᎬΝ❳
❲𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙾𝙽❳ ❲𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼❳
╰━━━━━❲☆ELAGNB AlEx☆❳━━━━━╯ ⇡ 
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𓆩ELAGNBE𓆪',url="t.me/Ure_rat"}},
{{text = '𓆩𝙨𝙤𝙪𝙧𝙘𝙚𓆪', url="t.me/mmmmm_70"}},
{{text = '', url="t.me/"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if text == 'اجنبي اليكس' or text == 'ELAGNBE' or text == 'اجنبي' then
local Text = [[
DEV ELAGNBE
]]
keyboard = {} 
...
if text == 'بار اجنبي اليكس' or text == '@Ure_rat' or text == 'متيجي' then
local Text = [[
おتع يقلبي انضم بار اجنبي اليكسお
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'بار اجنبي اليكس يقلبي ',url="t.me/UnclAgnbe"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/OSDDR&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'العاب ميكي' then
local Text = [[
SOURCE ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ
]]
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' お بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos')..') \n お تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' お بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos')..') \n お تـم قفـل التاك بالكتم ')
end,nil)   
...
if result.sender_user_id_ == tonumber(1859008079) then
send(msg.chat_id_, msg.id_, " お لا يمكنك حظر المبرمج اوس اوس\n")
return false 
end
...
if result.sender_user_id_ == tonumber(1859008079) then
send(msg.chat_id_, msg.id_, " お لا يمكنك كتم المبرمج اوس اوس\n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
...
usertext = '\n お العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos')..')'
status  = '\n お تم الغاء (الحظر-الكتم) عام من الكروبات'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Ahmedososs/ELGAMDEN/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n お اهلا بك في متجر ملفات ميكي\n お ملفات السورس ↓\nٴ≪┉ ┉ ┉ ┉ ┉ ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ ┉  ┉ ┉ ┉ ┉≫ٴ\n\n"
local TextE = "\nٴ≪┉ ┉ ┉ ┉ ┉ ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ ┉  ┉ ┉ ┉ ┉≫ٴ\n お علامة تعني { ✔️ } ملف مفعل\n お علامة تعني { ✖ } ملف معطل\n お قناة سورس ميكي ↓\n".." お [اضغط هنا لدخول](t.me/ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Ahmedososs/ELGAMDEN/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," お عذرا الملف لايدعم سورس ميكي \n") 
end
return false
end
...
if text == ("مسح قائمه ميكي") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n お تم مسح قائمه ميكي')
return false
end

if text == 'قائمه ميكي' and Sudo(msg) then
...
if text == ("رفع ميكي") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع ميكي @(.*)$") and Sudo(msg) then
local username = text:match("^رفع ميكي @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع ميكي (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع ميكي (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل ميكي") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل ميكي @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل ميكي @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل ميكي (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل ميكي (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
t = "お المنشئين الاساسين تعالو مخرب \nٴ≪┉ ┉ ┉ ┉ ┉ ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ ┉  ┉ ┉ ┉ ┉≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if #list == 0 then
t = "お ماكو منششئين يشوفولك جاره"
end
Reply_Status(msg,msg.sender_user_id_,"reply","お قام بنشر ملصق اباحيه\n"..t)  
...
Reply_Status(msg,msg.sender_user_id_,"reply","お قام بنشر صوره اباحيه\n"..t)  
DeleteMessage(msg.chat_id_,{[0] = tonumber(msg.id_),msg.id_})   
end   
end
...
send(msg.chat_id_, msg.id_," お منشئ الجروب » ["..b.first_name_.."](T.me/"..UserName..")")  
end,nil)   
end
end
end,nil)   
...
Reply_Status(msg,result.sender_user_id_,"reply","お تم ترقيته مطور ثانوي في البوت")  
end
...
Reply_Status(msg,result.id_,"reply","お تم ترقيته مطور ثانوي في البوت")  
else
...
Reply_Status(msg,userid,"reply","お تم ترقيته مطور ثانوي في البوت")  
return false 
end
...
Reply_Status(msg,result.sender_user_id_,"reply","お تم تنزيله من المطور ثانويين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_DRAGON, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply","お تم تنزيله من المطور ثانويين")  
else
send(msg.chat_id_, msg.id_,"お لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","お تم تنزيله من المطور ثانويين")  
return false 
end
if text == ("الثانويين") and SudoBot(msg) then
local list = database:smembers(bot_id.."Dev:SoFi:2")
t = "\nお قائمة مطورين الثانويين للبوت \nٴ≪┉ ┉ ┉ ┉ ┉ ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ ┉  ┉ ┉ ┉ ┉≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n お لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos')..')'
status  = '\n お تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n お العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n お العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n お العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n お العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos')..')'
...
send(msg.chat_id_, msg.id_, ' お تم تنزيل جميع البقرات بالجروب')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n お العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos')..')'
local  statuss  = '\n お تم رفع بقره في الجروب\n お ها يالهايشه تع احلبك'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n お العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos')..')'
status  = '\n お تم تنزيل بقره من الجروب\n お تعال هاك حليب مالتك'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " お لا تسطيع تقيد البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n お عذرا لا تستطيع تقيد ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
if Can_or_NotCan(result.id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n お عذرا لا تستطيع تقيد ( '..Rutba(result.id_,msg.chat_id_)..' )')
return false 
end      
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n お العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos')..')'
status  = '\n お تم تقيده لمدة ~ { '..TextEnd[2]..' '..TextEnd[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_..'&until_date='..tonumber(msg.date_+Time))
end
...
send(msg.chat_id_, msg.id_, '\n お عذرا لا تستطيع تقيد ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n お  العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos')..')'
status  = '\n お  الايدي » `'..result.sender_user_id_..'`\n お  تم تنزيله ادمن من الجروب بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
' }\n'..' お  امر منو ضافني » { '..addme..
' }\n'..' お  الردود » { '..rdmder..
' }\n'..' お  الردود العامه » { '..rdsudo..
' }\n'..' お  الايدي » { '..idgp..
' }\n'..' お  الايدي بالصوره » { '..idph..
' }\n'..' お  الرفع » { '..setadd..
' }\n'..' お  الحظر » { '..banm..' }\n\nٴ≪┉ ┉ ┉ ┉ ┉ ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ ┉  ┉ ┉ ┉ ┉≫ٴ\n お قناة سورس ميكي ↓\n [ ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ](t.me/ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
tdcli_function({ID="UnpinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_,"お تم الغاء تثبيت الكل")   
...
linkgp = ' お لا يوجد رابط ارسل ضع رابط'
end  
...
send(msg.chat_id_, msg.id_,' お تم ازالة صورة الجروب') 
end
return false  
end
...
send(msg.chat_id_, msg.id_,' お تم تفعيل ترحيب الجروب') 
return false  
end
...
send(msg.chat_id_, msg.id_,' お تم تعطيل ترحيب الجروب') 
return false  
end
if text == 'مسح الترحيب' or text == 'حذف الترحيب' then 
if Mod(msg) then
database:del(bot_id..'Get:Welcome:Group'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,' お تم ازالة ترحيب الجروب') 
end
end
...
if (c - x) == 0 then
send(msg.chat_id_, msg.id_, " お لا توجد بوتات في الجروب")
else
...
local f = ' お عدد البوتات التي هي ادمن >> {'..t..'}\n お ملاحضه علامة ال (お) تعني ان البوت ادمن \n'
...
send(msg.chat_id_, msg.id_," お تم حفظ قوانين الجروب") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
end  
...
if Mod(msg) then
send(msg.chat_id_, msg.id_," お تم ازالة قوانين الجروب")  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n お العضو » ['..result.title_..'](t.me/'..(text1[3] or 'ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos')..')'..'\n お تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if num > 1000 then 
send(msg.chat_id_, msg.id_,'おتستطيع التنظيف 1000 رساله كحد اقصى') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
send(msg.chat_id_,msg.id_,'お تم حذف {'..num..'}')  
...
send(msg.chat_id_, msg.id_,"お تم تنظيف جميع الميديا")
end
...
local Message = v
if Message then
t = "お تم مسح "..k.." من الوسائط الموجوده"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."S00F4:allM"..msg.chat_id_)
end
end
if #list == 0 then
t = "お لا يوجد ميديا في المجموعه"
end
send(msg.chat_id_, msg.id_, t)
end
...
local numl = v
if numl then
l = "お عدد الميديا الموجود هو "..k
end
end
if #num == 0 then
l = "お لا يوجد ميديا في المجموعه"
end
...
send(msg.chat_id_, msg.id_,'お تم تنظيف جميع الرسائل المعدله')
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ميكي').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ميكي')
local DRAGON_Msg = {
'ننعم يروحي 😻💙',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," お ليست لدي صلاحية تغير اسم الجروب")  
else
sebd(msg.chat_id_,msg.id_,' お تم تغيير اسم الجروب الى {['..Name..']}')  
end
end,nil) 
end
...
send(msg.chat_id_, msg.id_," お تم مسح الردود العامه")
end

if text == ("الردود العامه") and DevSoFi(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n お قائمة الردود العامه \nٴ≪┉ ┉ ┉ ┉ ┉ ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ ┉  ┉ ┉ ┉ ┉≫ٴ\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,' お تم حفظ الرد')
return false  
end  
end
if text and text:match("^(.*)$") then
if database:get(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_) == 'true' then
send(msg.chat_id_, msg.id_,' お ارسل الرد الذي تريد اضافته')
...
send(msg.chat_id_, msg.id_,' お تم ازالة الرد العام')
...
send(msg.chat_id_, msg.id_,' お ارسل الكلمه تريد اضافتها')
...
send(msg.chat_id_, msg.id_,' お ارسل الكلمه تريد حذفها')
...
send(msg.chat_id_, msg.id_,"お تم حذف الرد من ردود المتعدده")
...
send(msg.chat_id_, msg.id_,"おتم حذف ردود المتعدده")
end
------------------------------------------------------------------------
if text1 then 
...
send(msg.chat_id_, msg.id_," お تم مسح الردود")
end
...
send(msg.chat_id_, msg.id_,' お تم ازالة الرد ')
database:del(bot_id.."Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."Add:Rd:Manager:Text"..text..msg.chat_id_)   
...
send(msg.chat_id_, msg.id_,' お ارسل الكلمه التي تريد اضافتها')
...
send(msg.chat_id_, msg.id_,' お ارسل الكلمه التي تريد حذفها')
...
send(msg.chat_id_, msg.id_,'おلا يمكنني تعديل  او وضع لقب ليس لدي صلاحيه\n おقم بترقيتي جميع الصلاحيات او صلاحية اضافه مشرف ') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\nお العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos')..') '
status  = '\nお الايدي » '..result.sender_user_id_..'\nおتم ضافه {'..timsh..'} كلقب له'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=True&can_restrict_members=false&can_pin_messages=True&can_promote_members=false")
...
send(msg.chat_id_, msg.id_,'おوينك وين القب ') 
else
send(msg.chat_id_, msg.id_,'おلقبك هو : '..GeId.result.custom_title) 
end
end
...
send(msg.chat_id_, msg.id_,'\n おصلاحيات البوت هي\nٴ≪┉ ┉ ┉ ┉ ┉ ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ ┉  ┉ ┉ ┉ ┉≫ٴ\nお  علامة ال {✔️} تعني مفعل\nお  علامة ال {✖} تعني غير مفعل\nٴ≪┉ ┉ ┉ ┉ ┉ ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ ┉  ┉ ┉ ┉ ┉≫ٴ\nおتغير معلومات المجموعة ↞ '..INf..'\nおحذف الرسائل ↞ '..DEL..'\nおحظر المستخدمين ↞ '..REs..'\nおدعوة المستخدمين ↞ '..INv..'\nおثتبيت الرسالة ↞ '..Pin..'\nおاضافة مشرفين ↞ '..PRo)   
end
end
if text == "تعطيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_, '⌯ تم تعطيل الانستا')
database:set(bot_id.."ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"おتم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos:Tag:Admins:"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "おتم تعطيل تاك المشرفين")
end

if text == 'صيح المشرفين' or text == "تاك للمشرفين" or text == "وين المشرفين" or text == "المشرفين" then
if database:get(bot_id.."ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس ميكي يعني لو بكتهن راح اعرفك انت الاخذتهن
local t = "\nおالمستخدم ~ ["..User_id .."] يصيح المشرفين \nٴ≪┉ ┉ ┉ ┉ ┉ ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ ┉  ┉ ┉ ┉ ┉≫ٴ\n"
k = 0
...
return send(msg.chat_id_, msg.id_,"おارسل الرد الذي اريد اضافته")
end
...
return send(msg.chat_id_, msg.id_,"おارسل الان الكلمه لحذفها ")
end
if text then  
...
send(msg.chat_id_, msg.id_,"おتم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
end
if text then  
...
send(msg.chat_id_, msg.id_,"おتم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
end
if text then  
...
send(msg.chat_id_, msg.id_,"おتم حفظ الرد")
return false  
end  
end
if text then
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ميكي').." غادر" or text == 'غادر' then  
...
Text = '\n お تم تفعيل الردود العامه' 
else
Text = '\n お بالتاكيد تم تفعيل الردود العامه'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n お تم تعطيل الردود العامه' 
else
Text = '\n お بالتاكيد تم تعطيل الردود العامه'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos')..')'
local iduser = result.sender_user_id_
...
'\n\n お عدد رسائل الجروب : '..(msg.id_/2097152/0.5)..
'\n\n お  اسم الجروب : ['..ta.title_..']'
...
send(msg.chat_id_, msg.id_,' お عذرا لا استطيع طرد ادمنية الجروب') 
return false  
end
if data and data.ID and data.ID == 'Ok' then
send(msg.chat_id_, msg.id_,' お تم طردك من الجروب') 
...
if result.id_ then
send(msg.chat_id_, msg.id_,' お 😾تع يعم كلم الود دا قرفني [@'..username..']') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
...
send(msg.chat_id_, msg.id_,' お انت منشئ الجروب') 
return false
end
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = ' お هوا ابن الكلب دا الي ضافك😹» '..Name
sendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
end,nil)
else
send(msg.chat_id_, msg.id_,' お انت دخلت عبر الرابط يوسخ 🌝') 
end
end,nil)
else
...
Text = ' お تم تفعيل امر اطردني إلى عايز يخرج يتنيل 😹'
database:del(bot_id..'Cick:Me'..msg.chat_id_)  
else
Text = ' お بالتاكيد تم تفعيل امر اطردني مخلاص كفايه تفعيل الأمر 😾'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n お تم تعطيل امر اطردني اترزع هن بقى مفيش خروج 😹'
else
Text = '\n お بالتاكيد تم تعطيل امر اطردني مفيش خروج يولاد الكلب 😹'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "صورتي"  then
...
send(msg.chat_id_, msg.id_,'お تم تغير الايدي ارسل ايدي لرؤيته')
end
...
if result.status_.ID == "UserStatusRecently" and result.profile_photo_ ~= false then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, sofi.photos_[0].sizes_[1].photo_.persistent_id_,''..rdphoto..'\n- 𝐔𝐒𝐄𝐑𝐍𝐀𝐌𝐄 お  '..username..'\n お- 𝐌𝐒𝐆𝐒  '..Msguser..'\n お - 𝐒𝐓𝐀𝐓𝐒  '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n お - 𝐘𝐎𝐔𝐑.𝐈𝐃 '..msg.sender_user_id_..'\n- 𝐂𝐇 お @ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos\n')
else 
if result.status_.ID == "UserStatusEmpty" and result.profile_photo_ == false then
send(msg.chat_id_, msg.id_,'[\n- 𝐔𝐒𝐄??𝐍𝐀𝐌𝐄 お  '..username..'\n お- 𝐌𝐒𝐆𝐒  '..Msguser..'\n お - 𝐒𝐓𝐀𝐓𝐒  '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n お - 𝐘𝐎𝐔𝐑.𝐈𝐃 '..msg.sender_user_id_..'\n- 𝐂𝐇 お @ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos\n')
else
...
send(msg.chat_id_, msg.id_,  1, "お| تم اضافة له {"..numadded..'} من النقود', 1 , 'md')  
end
------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, ' お الان يمكنك ارسال الكليشه ⓵')
...
{
{text = 'SOURCE ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ', url="t.me/ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos"},
...
*ٴ≪┉ ┉ ┉ ┉ ┉ ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ ┉  ┉ ┉ ┉ ┉≫ٴ*
[ SOURCE ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ ](t.me/ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = 'SOURCE ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ', url="t.me/ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos"},
{text = 'مبرمج السورس', url="t.me/OSDDR"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_, t..'ٴ≪┉ ┉ ┉ ┉ ┉ ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ ┉  ┉ ┉ ┉ ┉≫ٴٴ\nお [ SOURC ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ ](t.me/ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos)')
end
if text == "تعطيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_, 'お تم تعطيل الابراج')
database:set(bot_id.." sofi:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_,'お تم تفعيل الابراج')
...
send(msg.chat_id_, msg.id_, 'お تم تعطيل حساب العمر')
...
send(msg.chat_id_, msg.id_,'お تم تفعيل حساب العمر')
...
{
{text = 'SOURCE  ᎪՏͲᎥҒᎬΝ', url="t.me/mmmmm_70"},
{text = 'مبرمج السورس', url="t.me/Ure_rat"},
},
}
...
お تكرار + عدد
◎⟼⟼⟼⟼⟼ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ⟻⟻⟻⟻⟻◎
[ SOURCE ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ ](t.me/mmmmm_70)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = 'SOURCE ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ', url="t.me/mmmmm_70"},
{text = 'مبرمج السورس', url="t.me/uu_ban"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
...
おامسح
おصلاحيه
おقائمه منع المتحركات
おقائمه منع الصور
おقائمه منع الملصقات
おمسح قائمه المنع
おالمحذوفين
◎⟼⟼⟼⟼⟼ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ⟻⟻⟻⟻⟻◎
お حذف  امر + الامر القديم  
◎⟼⟼⟼⟼⟼ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ⟻⟻⟻⟻⟻◎
お الاوامر المضافه ( لعرض الاوامر المضافه ) 
◎⟼⟼⟼⟼⟼ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ⟻⟻⟻⟻⟻◎
[ 𝒔𝒐𝒖𝒓𝒄𝒆 ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ ](t.me/mmmmm_70)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = 'SOURCE  ᎪՏͲᎥҒᎬΝ', url="t.me/ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
local Teext =[[
𝒘𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝒔𝒐𝒖𝒓𝒄𝒆 ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ
◎⟼⟼⟼⟼⟼ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ⟻⟻⟻⟻⟻◎
...
◎⟼⟼⟼⟼⟼ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ⟻⟻⟻⟻⟻◎
お تغير رد المطور + اسم
お تغير رد المالك + اسم
お تغير رد منشئ الاساسي + اسم
お تغير رد المنشئ + اسم
お تغير رد المدير + اسم
お تغير رد الادمن + اسم
お تغير رد المميز + اسم
お تغير رد العضو + اسم
お تغير امر الاوامر
お تغير امر ⓵ ~ الئ ⑩
◎⟼⟼⟼⟼⟼ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ⟻⟻⟻⟻⟻◎
...
◎⟼⟼⟼⟼⟼ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ⟻⟻⟻⟻⟻◎
おاستعاده الاوامر 
おتحويل كالاتي~⪼ بالرد على صوره او ملصق او صوت او بصمه بالامر ← تحويل 
おصيح ~ تاك ~ المميزين : الادمنيه : المدراء : المنشئين : المنشئين الاساسين
おكشف القيود
おتعين الايدي
おتغير الايدي
お الحساب + ايدي الحساب
おتنظيف + العدد
おتنزيل الكل
お تنزيل الكل
おمنع + برد
お~ الصور + متحركه + ملصق ~
おحظر ~ كتم ~ تقيد ~ طرد
おالمحظورين ~ المكتومين ~ المقيدين
おالغاء كتم + حظر + تقيد ~ بالرد و معرف و ايدي
おتقيد ~ كتم + الرقم + ساعه
おتقيد ~ كتم + الرقم + يوم
おتقيد ~ كتم + الرقم + دقيقه
おتثبيت ~ الغاء تثبيت
おالترحيب
おالغاء تثبيت الكل
おكشف البوتات
...
おتاك للاكساس
◎⟼⟼⟼⟼⟼ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ⟻⟻⟻⟻⟻◎
[ 𝒔𝒐𝒖𝒓𝒄𝒆 ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ](t.me/ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
◎⟼⟼⟼⟼⟼ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ⟻⟻⟻⟻⟻◎
おتفعيل ← تعطيل 
おالمجموعات ← المشتركين ← الاحصائيات
おرفع ← تنزيل منشئ اساسي
おمسح الاساسين ← المنشئين الاساسين
おمسح المنشئين ← المنشئين
おاسم ~ ايدي + بوت غادر 
おاذاعه 
◎⟼⟼⟼⟼⟼ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ⟻⟻⟻⟻⟻◎
[ 𝒔𝒐𝒖𝒓𝒄𝒆 ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ](t.me/ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos)
...
おقائمه العام
おمسح قائمه العام
おجلب نسخه الاحتياطيه
おرفع نسخه الاحتياطيه
◎⟼⟼⟼⟼⟼ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ⟻⟻⟻⟻⟻◎
おالمتجر 
おمتجر الملفات
おالملفات
おمسح الملفات
おتعطيل + تفعيل + اسم ملف
◎⟼⟼⟼⟼⟼ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ⟻⟻⟻⟻⟻◎
おاذاعه خاص
おاذاعه
おاذاعه بالتوجيه
...
お جلب نسخه البوت
おرفع نسخه البوت
おضع عدد الاعضاء + العدد
おضع كليشه المطور
おتفعيل/تعطيل الاذاعه
おتفعيل/تعطيل البوت الخدمي
おتفعيل/تعطيل التواصل
おتغير اسم البوت
おاضف/حذف رد عام
おالردود العامه
おمسح الردود العامه
◎⟼⟼⟼⟼⟼ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ⟻⟻⟻⟻⟻◎
おالاشتراك الاجباري
おتعطيل الاشتراك الاجباري
おتفعيل الاشتراك الاجباري
おحذف رساله الاشتراك
おتغير رساله الاشتراك
おتغير الاشتراك
◎⟼⟼⟼⟼⟼ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ⟻⟻⟻⟻⟻◎
おالاحصائيات
おالمشتركين
おالمجموعات 
おتفعيل/تعطيل المغادره
おتنظيف المشتركين
おتنظيف الجروبات
◎⟼⟼⟼⟼⟼ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ⟻⟻⟻⟻⟻◎
[ 𝒔𝒐𝒖𝒓𝒄𝒆 ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ](t.me/ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos)
...
おمصه بالرد
おرزله بالرد 
おشنو رئيك بهذا بالرد
おشنو رئيك بهاي بالرد
おتحب هذا
◎⟼⟼⟼⟼⟼ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ⟻⟻⟻⟻⟻◎
[ 𝒔𝒐𝒖𝒓𝒄𝒆 ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ ](t.me/ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos)
]]
...
{
{text = 'SOURCE ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ', url="t.me/ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos"},
{text = 'مبرمج السورس', url="t.me/OSSDR"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_, ' お تم تعطيل اوامر التسليه')
database:set(bot_id.."Fun_Bots:"..msg.chat_id_,"true")
end
if (text and text == "تفعيل اوامر التسليه") then 
send(msg.chat_id_, msg.id_, '  お تم تفعيل اوامر التسليه')
database:del(bot_id.."Fun_Bots:"..msg.chat_id_)
end
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ميكي')
...
send(msg.chat_id_,0," お العضو : {["..data.first_name_.."](T.ME/mmmmm_70)}\n お ["..DRAGONAbot.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = data.message_id_}) 
return false

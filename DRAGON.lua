...
local Text = [[
🕸️تع يقلبي انضم بار اجنبي اليكس🕸️
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local Text = [[ 
[CH](t.me/ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𓆩𝙨𝙤𝙪𝙧𝙘𝙚𓆪', url="t.me/ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_, " 🕸️ لا يمكنك حظر المبرمج اوس اوس\n")
return false 
end
...
function(arg,data) 
usertext = '\n 🕸️ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos')..')'
...
usertext = '\n 🕸️ العضو » ['..result.title_..'](t.me/'..(username or 'ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ_osos')..')'
status  = '\n 🕸️ تم حظره عام من الكروبات'
texts = usertext..status
...
if result.sender_user_id_ == tonumber(1859008079) then
send(msg.chat_id_, msg.id_, " 🕸️ لا يمكنك كتم المبرمج اوس اوس\n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  

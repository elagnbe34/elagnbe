...
if data.id_ then 
if data.id_ ~= bot_id then
local DRAGON_Cheng_User_Name = database:get(bot_id.."DRAGON:Cheng:UserName"..data.id_)
if not data.username_ then 
if DRAGON_Cheng_User_Name_ then 
...
if DRAGON_Cheng_User_Name ~= data.username_ then 
local Text = {
...
if data.id_ then 
if data.id_ ~= bot_id then 
local DRAGON_Cheng_Photo = database:get(bot_id.."DRAGON:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if DRAGON_Cheng_Photo_ then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."DRAGON:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if DRAGON_Cheng_Photo ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {

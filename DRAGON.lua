...
{ 'تفعيل الاشتراك الاجباريお  ' , 'تعطيل الاستراك الاجباري' },
...
if result.id_ then
database:srem(bot_id..'Sudo:User', result.id_)
usertext = '\nお︙ العضو » ['..result.title_..'](t.me/'..(username or 'te.m/mmmmm_70')..')'
status  = '\nお︙ تم تنزيله من المطورين'
texts = usertext..status
else
texts = 'お︙ لا يوجد حساب بهاذا المعرف'
...
*ٴ≪ـــــــــــــــــــــ𓆩 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴   𓆪ـــــــــــــــــــــ≫ٴ*
➫ .[ ❍ ┇𓆩 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴   𓆪. ](t.me/mmmmm_70)➤
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = '𝐃𝐑𝐀𝐆𝐎𝐍 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/mmmmm_70"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
🍁صورتي 
⩹━━━━━━ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴  ━━━━━━⩺
[🍁𝗦𝗢𝗨𝗥𝗖𝗘 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴  ⚡️](t.me/mmmmm_70)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
⩹━━━━━━ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴  ━━━━━━⩺
[✪ ????𝗨𝗥𝗖?? 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴  ✪](t.me/mmmmm_70)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
🗯️التاريخ
⩹━━━━━━ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴  ━━━━━━⩺
[🗯️ 𝗦𝗢𝗨𝗥𝗖𝗘 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴  🗯️](t.me/mmmmm_70)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if text == ''اجنبي التونز == '' then  
local Text = [[  
مبرمج السورس يروحيي
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = 'اجنبي التونز يروحي',url="t.me/ELAGNBE_ALTONZ"}},  

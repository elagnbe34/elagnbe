...
while(true) do
rm -fr ../.telegram-cli
screen -SASTIFN -X kill
screen -SASTIFN ./DRAGON
done
]])  
file:close() 
...
localASTIFN1_Msg = database:get(bot_id.."DRAGON1:Add:Filter:Rp2"..text..msg.chat_id_)   
ifASTIFN1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
ifASTIFN_Msg and not Special(msg) then  
localASTIFN_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
ifASTIFN_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
localASTIFNChengName = database:get(bot_id.."DRAGON:Cheng:Name"..data.id_)
if not data.first_name_ then 
ifASTIFNChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..DRAGONChengName..']')
database:del(bot_id.."DRAGON:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
ifASTIFNChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
if data.id_ then 
if data.id_ ~= bot_id then
localASTIFNChengUserName = database:get(bot_id.."DRAGON:Cheng:UserName"..data.id_)
if not data.username_ then 
ifASTIFNChengUserName then 
...
ifASTIFNChengUserName ~= data.username_ then 
local Text = {
...
if data.id_ then 
if data.id_ ~= bot_id then 
localASTIFNChengPhoto = database:get(bot_id.."DRAGON:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
ifASTIFNChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."DRAGON:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
ifASTIFNChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
t = "\nお︙ قائمة المنع \nٴ≪ـــــــــــــــــــــ𓆩 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝚃𝙸𝙵𝙴𝙽 𓏴   𓆪ـــــــــــــــــــــ≫ٴ\n"
for k,v in pairs(list) do  
localASTIFN_Msg = database:get(bot_id.."DRAGON1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..DRAGON_Msg.."}\n"    
end  
if #list == 0 then  
...
Namebot =ASTIFN_Msg[math.random(#DRAGON_Msg)]
...
------------------------------------------------------------------------
localASTIFNAbot = database:get(bot_id.."DRAGON1:Add:Filter:Rp2"..text..result.chat_id_)   
ifASTIFNAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"お︙ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\nお︙ ["..DRAGONAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
localASTIFN1_Msg = database:get(bot_id.."DRAGON1:Add:Filter:Rp2"..text..result.chat_id_)   
ifASTIFN1_Msg then    

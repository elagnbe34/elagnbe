...
local Text = [[
╭━━━━━❲☆𝐌𝐈𝐂𝐊𝐄𝐘☆❳━━━━━╮
❲𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 ՏΌႮᎡᏟᎬ ᎪՏͲᎥҒᎬΝ❳
...
if text == 'اوس اوس' or text == 'OSOS' or text == 'اوس' then
local Text = [[
DEV OSOSS
]]
keyboard = {} 
...
if text == 'بار اوس اوس' or text == '@OSDDR' or text == 'متيجي' then
local Text = [[
🕸️تع يقلبي انضم بار اوس اوس🕸️
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'بار اوس اوس يقلب',url="t.me/BAROSOSS"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/OSDDR&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

...
if res ~= 200 then
print('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻𝙼𝙻𝙺 ┉  ┉ ┉ ┉ ┉≫ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naٴ≪┉ ┉ ┉ ┉ ┉ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻𝙼𝙻𝙺 ┉  ┉ ┉ ┉ ┉≫ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴ≪┉ ┉ ┉ ┉ ┉ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻𝙼𝙻𝙺 ┉  ┉ ┉ ┉ ┉≫ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "ٴ≪┉ ┉ ┉ ┉ ┉ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻𝙼𝙻𝙺 ┉  ┉ ┉ ┉ ┉≫ٴ ┉ ┉ ┉ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉"
echo "TG IS NOT FIND IN FILES BOT"
echo "ٴ≪┉ ┉ ┉ ┉ ┉ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻𝙼𝙻𝙺 ┉  ┉ ┉ ┉ ┉≫ٴ ٴ≪┉ ┉ ┉ ┉ ┉ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻𝙼𝙻𝙺 ┉  ┉ ┉ ┉ ┉≫ٴ ┉"
exit 1
fi
if [ ! $token ]; then
echo "ٴ≪┉ ┉ ┉ ┉ ┉ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻𝙼𝙻𝙺 ┉  ┉ ┉ ┉ ┉≫ٴ ٴ≪┉ ┉ ┉ ┉ ┉ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻𝙼𝙻𝙺 ┉  ┉ ┉ ┉ ┉≫ٴ ┉ ┉"
...
var = true  
elseif tonumber(user_id) == tonumber(1842376997) then
var = true  
...
if tonumber(user_id) == tonumber(1842376997) then  
var = 'مطــور السـورس'
elseif tonumber(user_id) == tonumber(1805936474) then
var =  'مـبرمـج اجنبي اليكس'
elseif tonumber(user_id) == tonumber(1737072779) then
var = 'مطــور السـورس'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻𝙼𝙻𝙺.")  
...
℘ ⦑ SOURCE DRAGON ⦒ 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
℘︙ [Source Channel](t.me/SOURS_ALEX_V1)
℘︙ [Source Update ](t.me/SOURS_ALEX_V1)     
℘︙ [Source developer](t.me/Ure_rat)     
℘︙ [Dragon programmer](t.me/xX_maSterr_Xx) 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
𓂅 . [TWS GAKSON](t.me/UUUWt_bot)     
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
*🔟◂ اوامر الاعضاء .*
*ٴ≪┉ ┉ ┉ ┉ ┉ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻𝙼𝙻𝙺 ┉  ┉ ┉ ┉ ┉≫ٴ*
➫ .[🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 ELMAKL. ](t.me/SOURS_ALEX_V1)➤
]]
keyboard = {} 
...
{
{text = 'ELMALK 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/SOURS_ALEX_V1"},
},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_, msg.id_, t..'ٴ≪┉ ┉ ┉ ┉ ┉ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻𝙼𝙻𝙺 ┉  ┉ ┉ ┉ ┉≫ٴٴ\n℘︙ ➫ .[🖨┇𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻𝙼𝙻𝙺. ](t.me/S0DRG)➤ ')
end
...
℘︙ الاشعارات
ٴ┉ ┉ ┉ ┉ ┉ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻𝙼𝙻𝙺 ┉ ┉ ┉ ┉  ┉ٴٴ
➫ .[🖨┇𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻𝙼𝙻𝙺.](t.me/SOURS_ALEX_V1)➤
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = ' 𝙴𝙻𝙼𝙻𝙺 𝙲𝙷𝙰𝙽𝙽𝙴𝙻', url="t.me/S0DRG"},
},
}
...
{
{text = ' 𝙴𝙻𝙼𝙻𝙺 𝙲𝙷𝙰𝙽𝙽𝙴𝙻', url="t.me/SOURS_ALEX_V1"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
